...
for symbol in symbols:
    ...
    # rsi = minute_15_bars.ta.rsi()
    # rsi = minute_60_bars.ta.rsi()

    df = pd.concat([minute_5_bars['Close'], minute_5_bars['Open'], macd['MACD_12_26_9'], rsi], axis=1)
    print(df)
    ...
    #         if H_15m_C0 > limit_15m_H and 75.0 > RSI_15m_C0 > 55.0 and 0.00 < M_15m_C0 < limit_15m_M: 
