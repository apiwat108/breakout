...
for symbol in symbols:
    ...
    if symbol not in existing_position_symbols:
        ...
        # 60m uptrend with limit of retrace and bullsish reversal candlestick pattern (Bullish Engulfing and One White Soldier)
            # - Continuous green candelstick could be considered to add for more 60-m strategy later
        if H_60m_C0 > limit_60m_H and O_60m_P1 > C_60m_P1 and C_60m_C0 > O_60m_P1 and 75.0 > RSI_60m_C0 > 55.0: # Could add Bullish Engulfing or One White Soldier
