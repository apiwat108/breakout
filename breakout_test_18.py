...
for symbol in symbols:
    ...
    if symbol not in existing_position_symbols:
        ...
        if H_60m_C0 > limit_60m_H and C_60m_P1 < O_60m_C0 and O_60m_C0 >= C_60m_P1 and C_60m_C0 > C_60m_P1 and 75.0 > RSI_60m_C0 > 55.0: # Could add Bullish Engulfing or One White Soldier
            if H_15m_P1 < 0.00 and H_15m_C0 > 0.00 and 75.0 > RSI_15m_C0 > 55.0 and limit_15m_min_M < M_15m_C0 < limit_15m_max_M: # Bullish Engulfing
                if ((H_5m_C0 > 0.00 and H_5m_P1 < 0.00) or (M_5m_C0 > 0.00 and M_5m_P1 < 0.00)) and 75.0 > RSI_5m_C0 > 55.0 and M_5m_C0 < limit_5m_M: # Bullish Engulfing MCA 20 Dec --> 21 Dec
            ...
            elif O_15m_P1 > C_15m_P1 and C_15m_C0 > O_15m_P1 and O_15m_C0 <= C_15m_P1 and 75.0 > RSI_15m_C0 > 55.0 and limit_15m_min_M < M_15m_C0 < limit_15m_max_M: # Bullish Engulfing
                if ((H_5m_C0 > 0.00 and H_5m_P1 < 0.00) or (M_5m_C0 > 0.00 and M_5m_P1 < 0.00)) and 75.0 > RSI_5m_C0 > 55.0 and M_5m_C0 < limit_5m_M: # Bullish Engulfing MCA 20 Dec --> 21 Dec
                    print(f" - It's buy signal for Strategy 1.")
                    quantity = calculate_quantity(market_price)
                    print(f" - Placing buy order for {symbol} at {market_price}.\n")
            ...
            # TMC 5 Jan to 8 Jan
            elif C_15m_P2 < O_15m_P2 and O_15m_P1 >= C_15m_P2 and C_15m_P1 > O_15m_P2 and O_15m_C0 <= C_15m_P1 and 75.0 > RSI_15m_C0 > 50.0 and -0.0100 < M_15m_C0 < limit_15m_max_M and H_15m_C0 > -0.0050: # Bullish Engulfing
                if ((H_5m_C0 > 0.00 and H_5m_P1 < 0.00) or (M_5m_C0 > 0.00 and M_5m_P1 < 0.00)) and 75.0 > RSI_5m_C0 > 55.0 and -0.0100 < M_5m_C0 < limit_5m_M: # Bullish Engulfing MCA 20 Dec --> 21 Dec
                    print(f" - It's buy signal for Strategy 1.")
                    quantity = calculate_quantity(market_price)
                    print(f" - Placing buy order for {symbol} at {market_price}.\n")
                ...
                elif H_5m_P1 > 0.00 and H_5m_P2 < 0.00 and 75.0 > RSI_5m_C0 > 55.0 and M_5m_C0 < limit_5m_M: # Bullish Engulfing MCA 20 Dec --> 21 Dec
                    print(f" - It's buy signal for Strategy 1.")
                    quantity = calculate_quantity(market_price)
                    print(f" - Placing buy order for {symbol} at {market_price}.\n")
