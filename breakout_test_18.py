...
for symbol in symbols:
    ...
    O_60m_C0 = opens_60m[-2]
    C_60m_P1 = closes_60m[-3]
    O_60m_P1 = opens_60m[-3]

    C_15m_C0 = closes_15m[-1]
    O_15m_C0 = opens_15m[-2]
    C_15m_P1 = closes_15m[-3]
    O_15m_P1 = opens_15m[-3]
    C_15m_P2 = closes_15m[-4]
    O_15m_P2 = opens_15m[-4]
    ...
    (M_60m_all, S_60m_all, H_60m_all) = tulipy.macd(numpy.array(closes_60m[:-1]), short_period=short_period , long_period=long_period, signal_period=signal_period)      
    ...
    (M_15m_all, S_15m_all, H_15m_all) = tulipy.macd(numpy.array(closes_15m[:-1]), short_period=short_period , long_period=long_period, signal_period=signal_period)
    ...
    (M_5m_all, S_5m_all, H_5m_all) = tulipy.macd(numpy.array(closes_5m[:-1]), short_period=short_period , long_period=long_period, signal_period=signal_period)
