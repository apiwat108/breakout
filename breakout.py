            ...
            if existing_position_symbols:
                ...
                for symbol in existing_position_symbols:
                    ...
                    try:
                        ...
                        # EXIT STRATEGY 3: Timing Limit (20 trading days, no profit)
                            ...
                            if entry_d in trading_dates:
                                ...
                                # Check if current_date is at least 20 trading days after entry_d
                                if len(trading_dates) > entry_idx + 20 and current_date >= trading_dates[entry_idx + 20]:
                                    print(f"  ⏰ TIMING LIMIT: Over 15 trading days with no profit")
