    ...
    for symbol in symbols_5MX0_AB:
        ...
        if symbol not in existing_position_symbols:
            ...
            if symbol not in existing_order_symbols:
                ...
                # Entry Position 0: 60MX0 on M_1d_C0 < 0.0000
            ...
            try:
                ...
                if market_price <= trailing_stop_price and market_price < E_60m_C0:
            ...
            # # Strategy 1 for taking profit at least 0.75%
            # if market_value > (1.0075 * cost):
                # print(f" - It's taking-profit signal with min of 0.75% profit.")
                # place_sell_order(symbol, quantity)

            # Strategy 1 for taking profit at least 5%
            if market_value > (1.05 * cost):
                print(f" - It's taking-profit signal with min of 5% profit.")
                place_sell_order(symbol, quantity)

            # # Strategy 2 for cutting loss at 5%
            # if market_price < EMA_10d and market_value < (0.95 * cost):
            ...
            # Strategy 3F60MX0 for false 60MX0
            elif M_60m_C0 < 0.0000:
                print(f" - It's cut-loss signal with Strategy 3F60MX0.")
                place_sell_order(symbol, quantity)

            # Strategy 3E for cutting loss should not greater than 5% and cross down EMA
            elif market_value < (0.95 * cost) and market_price < E_60m_C0 and M_60m_C0 < 0.0000:
                print(f" - It's cut-loss signal with Strategy 3E (-5% and 60MPXDE).")
                place_sell_order(symbol, quantity)
