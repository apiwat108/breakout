...
# Dictionary to store the highest price for each symbol
highest_prices = {}
        ...
        if symbol not in existing_position_symbols:
            ...
            if symbol not in existing_order_symbols:
                ...
                if M_60m_C0 > 0.0000 and M_60m_P1 < 0.0000 and H_60m_C0 > 0.0000:
                    ...
                    # Check 1D condition
                    if M_1d_C0 > 0.0000 and H_1d_C0 > 0.0000: 
                ...
                elif M_15m_C0 > 0.0000 and M_15m_P1 < 0.0000 and M_60m_C0 > 0.0000:
                ...
                # Model_5MX0: 
                elif M_5m_C0 > 0.0000 and M_5m_P1 < 0.0000 and M_15m_C0 > 0.0000 and H_15m_C0 > 0.0000 and M_60m_C0 > M_60m_P1 and H_60m_C0 > H_60m_P1 > H_60m_Limit:
                    # (URGN 14 Jun 2024: It's not strong enough to make significant profit. So try to adjust 60 TF to H_60m_C0 > H_60m_P1)
                    # (FPI
                ...
                # (VZ 31 May 2024 09:30) 
                    ...
                    print(f" - It's buy signal for Model 5MXU")         
                    quantity = calculate_quantity(market_price)
                    place_buy_order(symbol, quantity)
            ...
            try:
                ...
                highest_price = max(high_prices[symbol])
                ...
                # Exit Position 2 If Entry Position 2: 60MX0 False
                ...
                elif market_value > (1.01 * cost) and M_5m_C0 < M_5m_P1 and 0.0000 < H_5m_C0 < H_5m_P1 and M_15m_C0 < M_15m_P1 and H_15m_C0 < H_15m_P1:
    ...
    for symbol in symbols_5MX0_BB:
        ...
        if symbol not in existing_position_symbols:
            ...
            try:
                ...
                # Initialize or update the highest price for trailing stop
                if symbol not in highest_prices:
                    highest_prices[symbol] = market_price
                    print(f" - Initializing highest_prices for {symbol} at {highest_prices[symbol]}")

                if market_price > highest_prices[symbol]:
                    highest_prices[symbol] = market_price
                    print(f" - Updated highest_prices for {symbol} to {highest_prices[symbol]}")

                print(f" - The highest_prices of {symbol} = {highest_prices[symbol]} compared to market price = {market_price}")
                ...
                elif market_value > (1.01 * cost) and M_5m_C0 < M_5m_P1 and H_5m_C0 < H_5m_P1 and M_15m_C0 < M_15m_P1 and H_15m_C0 < H_15m_P1 and M_60m_C0 < M_60m_P1 and H_60m_C0 < H_60m_P1:
