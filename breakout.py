...
def _get_col(df, name):
    """Return actual column name in DataFrame matching lower-case 'name' or None."""
    if df is None or df.empty:
        return None
    for c in df.columns:
...
def is_bearish_pin_bar(df, index=-1, body_max_ratio=0.3, upper_wick_min_ratio=2.0):
    """
        ...
        for symbol in symbols_5MX0_AB:
            ...
            if symbol not in existing_position_symbols:
                ...
                if symbol not in existing_order_symbols:
                    ...
                    if H_60m_C0 > 0.0000 and H_60m_P1 < 0.0000 and M_60m_P1 < 0.0000:
                        ...
                        # PXU_C0
                        if Close_60m_C0 > EMA_10_60m_C0 and Close_60m_P1 < EMA_10_60m_P1:
                        ...
                        # PXU_P1
                        elif Close_60m_C0 > EMA_10_60m_C0 and Close_60m_P1 > EMA_10_60m_P1 and Close_60m_P2 < EMA_10_60m_P2:
            ...
            ## -- EXIT -- ##
                ...
                if symbol not in existing_order_symbols or symbol in buy_order_symbols:
                    ...
                    elif M_60m_C0 < 0.0000 and M_60m_P1 > 0.0000:
