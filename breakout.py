        ...
        if symbol not in existing_position_symbols:
            ...
            if symbol not in existing_order_symbols:
                ...
                # Entry Position 3: 15MX0
                    ...
                    if M_1d_C0 > 0.0000 and H_1d_C0 > 0.0000 and M_60m_C0 > M_60m_P1 and M_60m_C0 > 0.0000: 
            ...
            if symbol not in existing_order_symbols:
                ...
                if V_1d_C0 > max(V_1d_P1_P10):
                    ...
                    if H_1d_P1 < 0.0000 and H_1d_C0 > 0.0000 and C_1d_C0 > E_1d_C0:
                        ...
                        if M_5m_C0 > 0.0000 and M_5m_P1 < 0.0000 and M_15m_C0 > 0.0000 and H_15m_C0 > 0.000 and H_60m_C0 > H_60m_Limit:
