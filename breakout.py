        ...
        if symbol not in existing_position_symbols:
            ...
            try:
                ...
                if entry_date is not None:
                    entry_date = entry_date.replace(tzinfo=pytz.timezone('America/New_York'))
                    # Round the entry_date to the nearest 5-minute interval
                ...
                new_high_prices = new_bars['High'].tolist()
