        ...
        if hasattr(config_manual, 'MANUAL_BREAKOUT_ENTRIES') and config_manual.MANUAL_BREAKOUT_ENTRIES:
            ...
            for entry in pending_entries:
                ...
                try:
                    ...
                    # Calculate 2% risk-based position size
                    risk_dollars = portfolio_value * config_manual.RISK_PERCENTAGE
                    ...
                    print(f"  Risk (2%): ${risk_dollars:,.2f}")
                    ...
                    if actual_position_value > portfolio_value:
                        print(f"  ⚠️  Insufficient funds (need ${actual_position_value:,.2f}, have ${portfolio_value:,.2f})")
                        print(f"  ✓ Tracking as VIRTUAL entry (logged to file)")
                        print(f"TRACK_MANUAL_VIRTUAL,{datetime.now().strftime('%Y-%m-%d %H:%M:%S')},{symbol},{current_price},{stop_loss_price},{quantity},{actual_position_value},insufficient_funds")
            ...
            if existing_position_symbols:
                ...
                for symbol in existing_position_symbols:
                    ...
                    try:
                        ...
                        # EXIT STRATEGY 3: Timing Limit (15 trading days, no profit)
                            ...
                            if entry_d in trading_dates:
                                ...
                                # Check if current_date is at least 15 trading days after entry_d
                                if len(trading_dates) > entry_idx + 15 and current_date >= trading_dates[entry_idx + 15]:
