...
def maximize_5MX0(market_value, cost, Close_5m_C0, Open_5m_C0, Close_5m_P1, M_5m_C0, M_5m_P1, M_5m_P2, H_5m_C0, H_5m_P1, symbol, quantity):
    """
            ...
            ## -- EXIT -- ##
                ...
                if symbol not in existing_order_symbols:
                    ...
                    # Strategy 3: Exit by timing (after 2 trading days, excluding weekends/holidays)
                        ...
                        trading_dates = [dt.datetime.strptime(day.date, '%Y-%m-%d').date() for day in calendar]
