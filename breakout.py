...
#                 # Model_I: 1d-MACD cross up 0-line and 60m-MACD cross up above 0-line 
...
#                         print(f" - It's buy signal for Model I: 1d-MACD cross up 0-line widh 60m-MACD cross up above 0-line")
...
#                 # Model_II: 1d-MACD cross up 0-line and 60m-MACD keep rising              
...
#                 # Model_III: 1d-MACD keep rising 1st time and 60m-MACD cross up 0-line               
...
#                     if M_1d_C0 > M_1d_P1 > 0.0000 and H_1d_C0 > 0.0000 and H_15m_C0 > 0.0000 and H_15m_P1 < 0.0000:
...
#                 # Model_IV: 1d-MACD keep rising 1st time and 60m-MACD keep rising            
#                 elif M_60m_C0 > M_60m_P1 > 0.0000 and H_60m_C0 > H_60m_P1 > 0.0000:

#                     # Significant Cross-up Factor 60m 
#                     # (HUSA 11 Apr 2024: H_60m_C0 = 0.0345 > H_60m_P1 = 0.0077 --> SBF = 4.48)
#                     SBF_60m_VI = round(H_60m_C0/H_60m_P1, decimal_point)
#                     SBF_60m_VI_threshold = 1.5

#                     # Check 1d condition
#                     if M_1d_C0 > M_1d_P1 > 0.0000:
#                         print(f" - It's buy signal for Model V: 60m-MACD keep rising and 1d-MACD cross up Signal above 0-line")
#                         print(f" - SBF_60m_VI = {SBF_60m_VI} > SBF_60m_VI_threshold = {SBF_60m_VI_threshold}")   
#                         quantity = calculate_quantity(market_price)
#                         print(f" - Placing buy order for {symbol} at {market_price}.\n")
...
#                 # Model_V: 1d-MACD keep rising 1st time and 60m-MACD cross up Signal above 0-line            
#                 elif M_60m_C0 > 0.0000 and H_60m_C0 > 0.0000 and H_60m_P1 < 0.0000:

#                     # Significant Cross-up Factor 60m 
#                     # (ACB 1 Apr 2024: H_60m_C0 = 0.0500 > H_60m_P1 = -0.0079 --> SCF = 733%)
#                     SCF_60m_V = round((H_60m_P1 - H_60m_C0)/H_60m_P1*100, decimal_point)      
#                     SCF_60m_V_threshold = 100

#                     # Check 1d condition
#                     if M_1d_C0 > M_1d_P1 > 0.0000:
#                         print(f" - It's buy signal for Model V: 1d-MACD keep rising 1st time and 60m-MACD cross up Signal above 0-line")
#                         print(f" - SCF_60m_V = {SCF_60m_V} > SCF_60m_V_threshold = {SCF_60m_V_threshold}")   
#                         quantity = calculate_quantity(market_price)
#                         print(f" - Placing buy order for {symbol} at {market_price}.\n")
...
#                 # Model_VI: 1d-MACD cross up Signal 1st time above 0-line and 60m-MACD cross up above 0-line 
...
#                 # Model_VII: 1d-MACD cross up Signal 1st time above 0-line and 60m-MACD keep rising              
#                 elif M_60m_C0 > M_60m_P1 > 0.0000 and H_60m_C0 > H_60m_P1 > 0.0000:

#                     # Significant Cross-up Factor 60m 
#                     # (VERU 28 Mar 2024: H_60m_C0 = 0.0099 > H_60m_P1 = 0.0044 --> SBF = 2.25)
#                     SBF_60m_V = round(H_60m_C0/H_60m_P1, decimal_point)
#                     SBF_60m_V_threshold = 1.5
