        ...
        for symbol in symbols_5MX0_AB:
            ...
            ## -- EXIT -- ##
                ...
                if symbol not in existing_order_symbols or symbol in buy_order_symbols:
                    ...
                    # Fix Strategy 6 and 7 and Entry point from M_60m_C0 to M_60m_P1 as well as H based on printed data structure When market is not to trade
                    # In market is not good to trade --> modify the code to use proper exit condition as well
