...
if clock.is_open:
    ...
    EMA_20d_bars_market = day_1_bars_market['Close'].ewm(span=20, adjust=False).mean()
    EMA_20d_market = EMA_20d_bars_market[-1]
    ...
    if C_1d_C0_market < EMA_20d_market and H_1d_C0_market < 0.0000:
        print(f"SPY is below EMA_10 ({C_1d_C0_market} < {EMA_20d_market}) and H_1d_C0_market ({H_1d_C0_market}) < 0.0000.")
    ...
    # Market is good to trade
        ...
        print(f"SPY is above EMA_10 ({C_1d_C0_market} > {EMA_20d_market}) and H_1d_C0_market ({H_1d_C0_market}) > 0.0000.\n")
        ...
        for symbol in symbols_5MX0_AB:
            ...
            ## -- EXIT -- ##
                ...
                if symbol not in existing_order_symbols:
                    ...
                    if H_1d_C0 < 0.0000 and market_value > cost:
                    ...
                    elif H_1d_C0 < 0.0000 and C_1d_C0 < 0.0000 and market_value < (0.97 * cost):
                        # NCV 18-23 Oct 2024
                        # Entry with 60MXU
