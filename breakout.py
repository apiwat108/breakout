            ...
            if symbol not in existing_position_symbols:
                ...
                if symbol not in existing_order_symbols:
                    ...
                    # End of Entry Options
                        ...
                        print(f" - M_5m_C0: {M_5m_C0}, M_5m_P1: {M_5m_P1}, H_5m_C0: {H_5m_C0}, RSI_5m_C0: {RSI_5m_C0}, Vol_5m_C0: {Vol_5m_C0}")
            ...
            ## -- EXIT -- ##
                ...
                if symbol not in existing_order_symbols:
                    ...
                    try:
                        ...
                        # Fix: Ensure minute_5_bars.index is a DatetimeIndex, not MultiIndex or tuple
                        bars_index = minute_5_bars.index
                        if isinstance(bars_index, pd.MultiIndex):
                            # If MultiIndex (symbol, timestamp), get the timestamp level
                            time_index = bars_index.get_level_values(-1)
                        else:
                            time_index = bars_index
                        # Now filter using Timestamp comparison
                        new_bars = minute_5_bars[time_index >= entry_date]
