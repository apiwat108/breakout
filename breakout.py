        ...
        if symbol not in existing_position_symbols:
            ...
            if symbol not in existing_order_symbols:
                ...
                if M_1d_C0 > 0.0000 and M_1d_P1 < 0.0000 and H_1d_C0 > H_1d_P1 > 0.0000:
                    ...
                    # Model_DX0-HXS: 1d-MACD cross up 0-line and 1h-MACD cross up Signal above 0-line
                    if M_60m_C0 > M_60m_P1 > 0.0000 and H_60m_C0 > 0.0000 and H_60m_P1 < 0.0000:
                        ...
                        SCF_60m_DX0_HXS = round((H_60m_P1 - H_60m_C0)/H_60m_P1*100, decimal_point)      
                        SCF_60m_DX0_HXS_threshold = 50

                        print(f" - It's buy signal for Model DX0-HX0")
                        print(f" - H_60m_P1 = {H_60m_P1}, H_60m_C0 = {H_60m_C0}, ")
                        print(f" - SCF_60m_DX0_HXS = {SCF_60m_DX0_HXS} > SCF_60m_DX0_HXS_threshold = {SCF_60m_DX0_HXS_threshold}")                           
                ...
                # Model_DR1: 1d-MACD keep rising 1st time              
                    ...
                    # Model_DR1-HXS: 1d-MACD keep rising 1st time and 1h-MACD cross up Signal above 0-line
                    elif M_60m_C0 > 0.0000 and H_60m_C0 > 0.0000 and H_60m_P1 < 0.0000: 

                        # Significant Cross-up Factor 60m 
                        # (ACB 1 Apr 2024: H_60m_C0 = 0.0500 > H_60m_P1 = -0.0079 --> SCF = 733%)
                        SCF_60m_DR1_HXS = round((H_60m_P1 - H_60m_C0)/H_60m_P1*100, decimal_point)      
                        SCF_60m_DR1_HXS_threshold = 100

                        print(f" - It's buy signal for Model DR1-HXS")
                        print(f" - SCF_60m_DR1_HXS = {SCF_60m_DR1_HXS} > SCF_60m_DR1_HXS_threshold = {SCF_60m_DR1_HXS_threshold}")   
                        quantity = calculate_quantity(market_price)
                        print(f" - Placing buy order for {symbol} at {market_price}.\n")
                ...
                # Model_DX1: 1d-MACD cross up Signal 1st time above 0-line
                    ...
                    # Model_DX1-HXS: 1d-MACD cross up Signal 1st time above 0-line and 60m-MACD cross up Signal above 0-line 
                    if M_60m_C0 > M_60m_P1 > 0.0000 and H_60m_C0 > 0.0000 and H_60m_P1 < 0.0000 :

                        # Significant Cross-up Factor 60m 
                        # (TARS 13 Nov 2023: H_60m_C0 = 0.0065 > H_5m_P1 = -0.0225 --> SCF = 129%)
                        # Keep recoding the proper SCF_60m_threshold
                        SCF_60m_DX1_HXS = round((H_60m_P1 - H_60m_C0)/H_60m_P1*100, decimal_point)      
                        SCF_60m_DX1_HXS_threshold = 50

                        print(f" - It's buy signal for Model DX1_HXS")
                        print(f" - H_60m_C0 = {H_60m_C0} > H_60m_P1 = {H_60m_P1}")
                        print(f" - SCF_60m_DX1_HXS = {SCF_60m_DX1_HXS} > SCF_60m_DX1_HXS_threshold = {SCF_60m_DX1_HXS_threshold}")   
                        quantity = calculate_quantity(market_price)
                        print(f" - Placing buy order for {symbol} at {market_price}.\n")
