...
if clock.is_open:
    ...
    if EMA_10d_market is not None and C_1d_C0_market is not None and H_1d_C0_market is not None and C_1d_C0_market < EMA_10d_market and H_1d_C0_market < 0.0000:
        ...
        if existing_position_symbols:
            ...
            for symbol in existing_position_symbols:
                ...
                try:
                    minute_60_bars_open = minute_5_bars_open[ohlcv_cols].resample(
                        '60T', label='left', closed='left', origin='start_day', offset=pd.Timedelta(minutes=30)
                    ).agg({
                        'open': 'first',
                        'high': 'max',
                        'low': 'min',
                    ...
                    minute_60_bars_open = minute_5_bars_open[ohlcv_cols].resample('60T', label='left', closed='left').agg({
                        'open': 'first',
                        'high': 'max',
                        'low': 'min',
                        'close': 'last',
            ...
            print(f"minute_60_bars_open for {symbol}:")
            print(minute_60_bars_open)
            ...
            # print("\n--- MACD (12,26,9) last values (market open only) ---")
            # if not macd_5.empty:
            #     print(macd_5.tail(10))
            # else:
            #     print("MACD DataFrame is empty!")

            macd_1 = compute_macd(day_1_bars)
            decimal_point = 4
            H_1d_C0 = round(macd_1['MACDh_12_26_9'].iloc[-1], decimal_point) if not macd_1.empty and 'MACDh_12_26_9' in macd_1.columns else None
        ...
        for symbol in symbols_5MX0_AB:
            ...
            if symbol not in existing_position_symbols:
                ...
                if symbol not in existing_order_symbols:
                    ...
                    if H_60m_P1 > 0.0000 and H_60m_P2 < 0.0000 and M_60m_P2 < 0.0000 and Close_60m_P1 > Open_60m_P1:
                        ...
                        # PXU_P1
                        if Close_60m_C0 > EMA_10_60m_C0 and Close_60m_P1 > EMA_10_60m_P1 and Close_60m_P2 < EMA_10_60m_P2:
                        ...
                        # PXU_P2
                        elif Close_60m_C0 > EMA_10_60m_C0 and Close_60m_P1 > EMA_10_60m_P1 and Close_60m_P2 > EMA_10_60m_P2 and Close_60m_P3 < EMA_10_60m_P3:
                        ...
                        # PXU_P3
                        elif Close_60m_C0 > EMA_10_60m_C0 and Close_60m_P1 > EMA_10_60m_P1 and Close_60m_P2 > EMA_10_60m_P2 and Close_60m_P3 > EMA_10_60m_P3 and Close_60m_P4 < EMA_10_60m_P4:
                        ...
                        # PXU_P4
                        elif Close_60m_C0 > EMA_10_60m_C0 and Close_60m_P1 > EMA_10_60m_P1 and Close_60m_P2 > EMA_10_60m_P2 and Close_60m_P3 > EMA_10_60m_P3 and Close_60m_P4 > EMA_10_60m_P4 and Close_60m_P5 < EMA_10_60m_P5:
                        ...
                        # PXU_P5
                        elif Close_60m_C0 > EMA_10_60m_C0 and Close_60m_P1 > EMA_10_60m_P1 and Close_60m_P2 > EMA_10_60m_P2 and Close_60m_P3 > EMA_10_60m_P3 and Close_60m_P4 > EMA_10_60m_P4 and Close_60m_P5 < EMA_10_60m_P5 and Close_60m_P6 < EMA_10_60m_P6:
                        ...
                        # PXU_P6
                        elif Close_60m_C0 > EMA_10_60m_C0 and Close_60m_P1 > EMA_10_60m_P1 and Close_60m_P2 > EMA_10_60m_P2 and Close_60m_P3 > EMA_10_60m_P3 and Close_60m_P4 > EMA_10_60m_P4 and Close_60m_P5 > EMA_10_60m_P5 and Close_60m_P6 < EMA_10_60m_P6 and Close_60m_P7 < EMA_10_60m_P7:
                    ...
                    elif Close_60m_C0 > EMA_10_60m_C0 and Close_60m_P1 < EMA_10_60m_P1:
                        print(f" - 60PXU Detected.")
                        print(f" - The 60-min price: {Close_60m_C0} is above EMA_10-60m: {EMA_10_60m_C0}")

                        # 60MXU_P1
                        if H_60m_C0 > 0.0000 and H_60m_P1 > 0.0000 and H_60m_P2 < 0.0000 and M_60m_P2 < 0.0000:
                    ...
                    # No Entry Position detected
                        ...
                        print(f" - The 60-min price: {Close_60m_C0} is below EMA_10-60m: {EMA_10_60m_C0} at {percentage_from_ema10_60m:.2f}%\n")
            ...
            ## -- EXIT -- ##
                ...
                if symbol not in existing_order_symbols or symbol in buy_order_symbols:
                    ...
                    # Strategy 1 - 1-day candlestick pattern exits
                    ...
                    # Bearish Pin Bar: uses only the most recent daily bar
                    if day_df_for_patterns is not None and is_bearish_pin_bar(day_df_for_patterns, idx=-1) and M_1d_C0 is not None and M_1d_P1 is not None and M_1d_C0 > M_1d_P1:
                        print(f" - Bearish Pin Bar detected for {symbol}.")
                    ...
                    # Bearish Engulfing: requires at least two daily bars (current + previous)
                    elif day_df_for_patterns is not None and len(day_df_for_patterns) >= 2:
                        last2 = day_df_for_patterns.tail(2)
                        if is_bearish_engulfing(last2, idx=-1) and M_1d_C0 is not None and M_1d_P1 is not None and M_1d_C0 > M_1d_P1:
                            print(f" - Bearish Engulfing detected for {symbol}.")
                            TRACK_1D_EXIT = f"TRACK_1D_EXIT,{datetime.now().strftime('%Y-%m-%d %H:%M:%S')},{symbol},{market_price},{entry_price},{market_value},{cost},{((market_value - cost) / cost) * 100:.2f}%"
                            print(TRACK_1D_EXIT)
                            place_sell_order(symbol, quantity)
                    
                    # # Strategy 1-TP for 60MXU taking profit (maximize_60MXU)
                    # elif market_value > (1.005 * cost):
                    #     print(f" - It's profit taking signal for 60MXU, profit > 0.5%.")
                    #     maximize_60MXU(Close_60m_C0, Open_60m_C0, Close_60m_P1, M_60m_C0, M_60m_P1, M_60m_P2, H_60m_C0, H_60m_P1, symbol, quantity)
                    ...
                    # Strategy 1-CL for 60MXD cutting loss (cut_loss_60MXD)
                    elif M_60m_C0 < 0.0000 and M_60m_P1 > 0.0000 and Close_1d_C0 < EMA_10d:
                        print(f" - It's cut-loss signal for 60MXD, M_60m_C0 < 0.0000 and M_60m_P1 > 0.0000.")
                        place_sell_order(symbol, quantity)
                    ...
                    # Strategy 3: Exit by timing (after 3 trading days, excluding weekends/holidays)
                        ...
                        if entry_d in trading_dates:
                            ...
                            if len(trading_dates) > entry_idx + 3 and current_date >= trading_dates[entry_idx + 3] and M_60m_C0 < 0.0000:
                    ...
                    elif H_1d_C0 is not None and H_1d_C0 < 0.0000 and H_60m_C0 < 0.0000:
