...
if clock.is_open:
    ...
    # Market is good to trade
    elif C_1d_C0_market > EMA_10d_market and H_1d_C0_market > 0.0000:
        ...
        for symbol in symbols_5MX0_AB:
            ...
            most_updated_5m_close = minute_5_bars['Close'].iloc[-1]
            minute_5_bars.iloc[-2]['Close'] = most_updated_5m_close
            minute_5_bars.drop(index=minute_5_bars.index.iloc[-1],axis=0,inplace=True)
            ...
            most_updated_60m_close = minute_60_bars['Close'].iloc[-1]
            minute_60_bars.iloc[-2]['Close'] = most_updated_60m_close
            minute_60_bars.drop(index=minute_60_bars.index.iloc[-1],axis=0,inplace=True)
