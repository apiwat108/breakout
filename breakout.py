    ...
    for symbol in symbols_5MX0_AB:
        ...
        if symbol not in existing_position_symbols:
            ...
            try:
                ...
                print(f" - The highest_prices of {symbol} = {highest_prices[symbol]} compare to market price = {market_price}")
                ...
                # Strategy 0 Test get the profit as soon as possible
                elif market_value > cost:
                    print(f" - It's taking-profit as quick as possible.")
                    place_sell_order(symbol, quantity)
    ...
    for symbol in symbols_5MX0_BB:
        ...
        if symbol not in existing_position_symbols:
            ...
            if symbol not in existing_order_symbols:
                ...
                if V_1d_C0 > max(V_1d_P1_P10):
                    ...
                    # No 1DXU
                        ...
                        print(f" - Waiting for 1DXU signale\n")
            ...
            try:
                ...
                elif M_5m_C0 < M_5m_P1 and H_5m_C0 < H_5m_P1 and M_15m_C0 < M_15m_P1 and H_15m_C0 < H_15m_P1 and M_60m_C0 < M_60m_P1 and H_60m_C0 < H_60m_P1:
