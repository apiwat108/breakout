...
if clock.is_open:
    ...
    for symbol in symbols_5MX0_BB:
        ...
        if symbol not in existing_position_symbols:
            ...
            # Strategy 1-60m try taking profit at least 1.0% with open up more profit in 60m TF
            elif market_value > (1.01 * cost) and M_60m_C0 < M_60m_P1 and 0.0000 < H_60m_C0 < H_60m_P1:
