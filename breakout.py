...
if clock.is_open:
    ...
    for symbol in symbols_5MX0_AB:
        ...
        if symbol not in existing_position_symbols:
            ...
            if market_value > (1.01 * cost) and M_5m_C0 < M_5m_P1 and 0.0000 < H_5m_C0 < H_5m_P1:
    ...
    for symbol in symbols_5MX0_BB:
        ...
        if symbol not in existing_position_symbols:
            ...
            if symbol not in existing_order_symbols:
                ...
                # Check Signal
                elif M_5m_C0 > 0.0000 and M_5m_P1 < 0.0000 and H_15m_C0 > 0.0000 and H_15m_P1 < 0.0000:
                ...
                # Check Signal
                elif H_5m_C0 > 0.0000 and H_5m_P1 < 0.0000 and M_5m_C0 > 0.0000 and H_15m_C0 > 0.0000 and H_15m_P1 < 0.0000:
                ...
                # Check Signal
                elif M_5m_C0 > M_5m_P1 > 0.0000 and M_15m_C0 > 0.0000 and M_15m_P1 < 0.0000:
                    ...
                    # Check Significant Factors
                    if SBF_5m > SBF_5m_threshold:
                        print(f" - It's buy signal for Model 5MKR-15MXU-60MKR")         
                        quantity = calculate_quantity(market_price)
                        print(f" - Placing buy order for {symbol} at {market_price}.")
