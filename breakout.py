...
if clock.is_open:
    ...
    for symbol in symbols_DX0:
        ...
        if symbol not in existing_position_symbols:
            ...
            if symbol not in existing_order_symbols:
                ...
                if M_1d_C0 > 0.0000 and M_1d_P1 < 0.0000 and H_1d_C0 > H_1d_P1 > 0.0000:
                    ...
                    # Model_DX0-H-END
                        ...
                        print(" - Some 60m-conditions do not pass for Model DX0\n")  

                # Model_DX0_END
                else:
                    print(" - The 1d-conditions do not pass for Models DX0\n")
            ...
            # Strategy 4 in case of false DX0
            elif M_1d_C0 < 0.0000 and market_value < (0.925 * cost) :
                print(f" - It's false DX0")
                print(f" - Placing sell order for {symbol} at {market_price}.\n")
    ...
    for symbol in symbols_DR1:
        ...
        if symbol not in existing_position_symbols:
            ...
            if symbol not in existing_order_symbols:
                ...
                if M_1d_C0 > M_1d_P1 > 0.0000 and H_1d_C0 > 0.0000 and H_1d_P1 > 0.0000:
                    ...
                    # Model_DR1-END
                        ...
                        print(" - Some 60m-conditions do not pass for Model DR1\n")  

                # Model_DR1_END
                else:
                    print(" - The 1d-conditions do not pass for Models DR1\n")
            ...
            # Strategy 2 for cutting loss
            elif market_price < EMA_10d and market_value < (0.920 * cost):
                print(f" - It's cut-loss signal.")
                print(f" - Placing sell order for {symbol} at {market_price}.\n")
    ...
    for symbol in symbols_DX1:
        ...
        if symbol not in existing_position_symbols:
            ...
            if symbol not in existing_order_symbols:
                ...
                if M_1d_C0 > M_1d_P1 > 0.0000 and H_1d_C0 > 0.0000 and H_1d_P1 < 0.0000:
                    ...
                    # Model_DX1-END
                        ...
                        print(" - Some 60m-conditions do not pass for Model DX1\n")  

                # Model_DX1_END
                else:
                    print(" - The 1d-conditions do not pass for Models DX1\n")
            ...
            # Strategy 4 in case of false DX1
            elif H_1d_C0 < 0.0000:
                print(f" - It's false DX1")
                print(f" - Placing sell order for {symbol} at {market_price}.\n")
