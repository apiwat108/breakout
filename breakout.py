...
if clock.is_open:
    ...
    # Market is good to trade
        ...
        for symbol in symbols_5MX0_AB:
            ...
            # Print last close of day_1_bars
            ...
            # Update the most recent 5m close
            ...
            # Update the most recent 15m close
            most_updated_15m_close = minute_15_bars['Close'].iloc[-1]
            ...
            # Update the most recent 60m close
