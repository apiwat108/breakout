    ...
    if symbol not in existing_position_symbols:
        ...
        if symbol not in existing_order_symbols:
            ...
            if M_60m_C0 > M_60m_P1 > 0.0000 and H_60m_C0 > 0.0000 and H_60m_P1 < 0.0000:
                ...
                if M_15m_C0 > M_15m_P1 > 0.0000 and H_15m_C0 > H_15m_P1 > 0.0000:
            ...
            # Model_01C: Continuous (CIEN 1 Mar 2024)                  
            SBF_60m = 5                 # Significant Breakout Factor 60m (CIEN 1 Mar 2024: H_60m_C0 = 0.1482 > H_60m_P1 = 0.0216 --> SBF = 6.86)
            if M_60m_C0 > M_60m_P1 > 0.0000 and H_60m_C0 > (SBF_60m * H_60m_P1):
                ...
                if M_15m_C0 > M_15m_P1 > 0.0000 and H_15m_C0 > (SBF_15m * H_15m_P1):
                    ...
                    SCF_5m = (H_5m_P1 - H_5m_C0)/H_5m_P1            # Significant Cross-up Factor 5m (CIEN 1 Mar 2024: H_5m_C0 = 0.0247 > H_5m_P1 = -0.0027 --> SCF = 1014%)
