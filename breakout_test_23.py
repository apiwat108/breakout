        ...
        if symbol not in existing_position_symbols:
            ...
            if symbol not in existing_order_symbols:
                ...
                if M_60m_C0 > M_60m_P1 > 0.0000 and H_60m_C0 > 0.0000 and H_60m_P1 < 0.0000: # need SBF
                    ...
                    SCF_60m = (H_60m_P1 - H_60m_C0)/H_60m_P1*100          
                    ...
                    # Model_01A-02: 15m-MACD cross up (DOCN 8 Mar 2024: H_15m_C0 = 0.0368 > H_15m_P1 = -0.0181 --> SCF = 303%)
                        ...
                        SCF_15m_01A_02 = (H_15m_P1 - H_15m_C0)/H_15m_P1*100          
                        SCF_15m_01A_02_threshold = 200                        
                        ...
                        if SCF_15m_01A_02 > SCF_15m_01A_02_threshold and ((H_5m_C0 > 0.000 and H_5m_P1 < 0.000) or (M_5m_C0 > 0.000 and M_15m_P1 < 0.0000)):
                            print(f" - It's buy signal for BB_1 Strategy, Model_01-02-01")
                            quantity = calculate_quantity(market_price)
                            print(f" - Placing buy order for {symbol} at {market_price}.\n")
                ...
                # Model_01C: 60m-MACD Continuous (IBKR 2 Feb, CIEN and FIP 1 Mar 2024)                  
                    ...
                    SBF_60m_01C = H_60m_C0/H_60m_P1
                    SBF_60m_01C_threshold = 1.5                                
                    if H_60m_C0 > (SBF_60m_01C * H_60m_P1):
                        print(f' - SBF_60m_01C = {SBF_60m_01C}')                                        
       
                        # Model_01C-01: 15m-MACD Countinuous (CIEN 1 Mar 2024)
                        if M_15m_C0 > M_15m_P1 > 0.0000:
                            # Significant Breakout Factor 15m (CIEN 1 Mar 2024: H_15m_C0 = 0.0869 > H_15m_P1 = 0.0031 --> SBF = 28.03)
                            SBF_15m_01C_01 = 25
                            if H_15m_C0 > (SBF_15m_01C_01 * H_15m_P1):

                                # Model_01C-01-01: 5m-MACD cross up (CIEN 1 Mar 2024)
                                # Significant Cross-up Factor 5m (CIEN 1 Mar 2024: H_5m_C0 = 0.0247 > H_5m_P1 = -0.0027 --> SCF = 1014%)
                                SCF_5m_01C_01_01 = (H_5m_P1 - H_5m_C0)/H_5m_P1*100            
                                SCF_5m_01C_01_01_threshold = 500
                                if M_5m_C0 > M_5m_P1 > 0.0000 and H_5m_C0 > 0.0000 and H_5m_P1 < 0.0000 and SCF_5m_01C_01_01 > SCF_5m_01C_01_01_threshold:
                                ...
                                print(f' - SBF_15m_01C_01 is less than {SBF_15m_01C_01}\n')
     
                        # Model_01C-02: 15m-MACD Gap Up (IBKR 2 Feb 2024)
                            ...
                            SBF_15m_01C_02 = 5
                            if H_15m_C0 > (SBF_15m_01C_02 * H_15m_P1):

                                # Model_01C-02-01: 5m-MACD cross up (IBKR 2 Feb 2024)
                                # Significant Cross-up Factor 5m 
                                # (IBKR 2 Feb 2024: H_5m_C0 = 0.0916 > H_5m_P1 = -0.0027 --> SCF = 3493%)
                                ...
                                print(f' - SBF_15m_01C_02 of {SBF_15m_01C_02} is too low\n')

                        # Model_01C-03: 15m-MACD Cross Up (DOCN 8 Mar 2024)
                        elif H_15m_C0 > 0.0000 and H_15m_P1 < 0.0000 and C_15m_C0 > C_15m_P1 and C_15m_C0 > O_15m_C0:

                            # Significant Cross Up Factor 15m (DOCN 8 Mar 2024: H_15m_C0 = 0.0368 > H_15m_P1 = -0.0181 --> SCF = 303%)
                            SCF_15m_01C_03 = (H_15m_P1 - H_15m_C0)/H_15m_P1*100
                            SCF_15m_01C_03_threshold = 100
                            if SCF_15m_01C_03 > SCF_15m_01C_03_threshold:

                                # Model_01C-03-01: 5m-MACD cross up (DOCN 8 Mar 2024)
                                # Significant Cross-up Factor 5m 
                                # (DOCN 8 Mar 2024: H_5m_C0 = 0.0134 > H_5m_P1 = -0.0127 --> SCF = 205%)
                                SCF_5m_01C_03_01 = (H_5m_P1 - H_5m_C0)/H_5m_P1*100            
                                SCF_5m_01C_03_01_threshold = 200
                                if H_5m_C0 > 0.0000 and H_5m_P1 < 0.0000 and SCF_5m_01C_03_01 > SCF_5m_01C_03_01_threshold:
                                ...
                                print(f' - SCF_15m_01C_03 of {SCF_15m_01C_03} is too low\n')

                        else:
                            print(" - 15m conditions do not pass for Strategy 1\n")

                    else:
                        print(f" - SBF_60m_01C of {SBF_60m_01C} is too low\n")
