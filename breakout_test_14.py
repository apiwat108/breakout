...
for symbol in symbols:
    ...
    if symbol not in existing_position_symbols:
        ...
        # Strategy 2
            ...
            if M_5m_C0 < 0 and H_5m_C0 > H_5m_P1 > H_5m_P2 > 0 and H_5m_P3 < 0:
        ...
        # Strategy 1 for sell
        if (0 < H_5m_C0 < H_5m_P1 < H_5m_P2 and H_5m_P2 > H_5m_P3 and M_5m_P2 > 0 and S_5m_P3 > 0) or (H_5m_P1 > 0 and H_5m_C0 < 0):
