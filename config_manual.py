...
RISK_PERCENTAGE = 0.02  # 2% risk per trade, calculated from current buying power
...
USE_BUYING_POWER_FOR_RISK = True  # Use Alpaca buying_power instead of portfolio_value for new entries
