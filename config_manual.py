...
BUYING_POWER_USAGE_LIMIT = 0.95  # Keep a 5% buying power buffer for price movement/rejections
...
MANUAL_BREAKOUT_ENTRIES = [
    ...
    {'symbol': 'TPG', 'breakout_date': '2026-08-04', 'stop_loss': 46.2, 'entry_id': 191},
]
