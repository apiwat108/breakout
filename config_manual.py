...
RISK_PERCENTAGE = 0.02  # 2% risk per trade, calculated from portfolio value
MAX_POSITION_VALUE = 10000  # Maximum position value in USD (adjusted for live account)
MIN_POSITION_VALUE = 1000  # Minimum position value in USD (adjusted for live account)
USE_BUYING_POWER_FOR_RISK = False  # Use portfolio_value for risk sizing; buying_power is only an availability check
BUYING_POWER_USAGE_LIMIT = 0.75  # Use up to 75% of buying power; keep a 25% buffer
...
ENTRY_WINDOW_HOUR = 9  # Allow entries only during this market open hour (ET)
# Alpaca Data API URL
...
MANUAL_BREAKOUT_ENTRIES = [
    ...
    # {'symbol': 'AURA', 'breakout_date': '2026-05-04', 'stop_loss': 7.0, 'entry_id': 100},  # Not in positions
    ...
    # {'symbol': 'QMCO', 'breakout_date': '2026-05-06', 'stop_loss': 9.0, 'entry_id': 109},  # Not in positions  # Not in positions
    ...
    # {'symbol': 'PLSE', 'breakout_date': '2026-05-14', 'stop_loss': 22.8, 'entry_id': 113},  # Not in positions
    ...
    # {'symbol': 'SACH', 'breakout_date': '2026-05-18', 'stop_loss': 1.08, 'entry_id': 118},  # Not in positions
    ...
    # {'symbol': 'HOVR', 'breakout_date': '2026-05-22', 'stop_loss': 2.5, 'entry_id': 129},  # Not in positions
    # {'symbol': 'HLIT', 'breakout_date': '2026-05-22', 'stop_loss': 13.7, 'entry_id': 130},  # Not in positions
    ...
    # {'symbol': 'TEO', 'breakout_date': '2026-05-27', 'stop_loss': 12.7, 'entry_id': 136},  # Not in positions  # Not in positions  # Not in positions
    ...
    # {'symbol': 'PD', 'breakout_date': '2026-05-29', 'stop_loss': 8.6, 'entry_id': 142},  # Not in positions
    # {'symbol': 'CHA', 'breakout_date': '2026-05-29', 'stop_loss': 11.3, 'entry_id': 143},  # Not in positions
    # {'symbol': 'ASAN', 'breakout_date': '2026-05-29', 'stop_loss': 7.0, 'entry_id': 144},  # Not in positions
    # {'symbol': 'RPD', 'breakout_date': '2026-05-29', 'stop_loss': 7.5, 'entry_id': 145},  # Not in positions
    # {'symbol': 'INDP', 'breakout_date': '2026-06-04', 'stop_loss': 2.1, 'entry_id': 146},  # Not in positions
    # {'symbol': 'HCAT', 'breakout_date': '2026-06-04', 'stop_loss': 1.65, 'entry_id': 147},  # Not in positions
    # {'symbol': 'VERU', 'breakout_date': '2026-06-04', 'stop_loss': 2.1, 'entry_id': 148},  # Not in positions
    # {'symbol': 'CALC', 'breakout_date': '2026-06-05', 'stop_loss': 0.84, 'entry_id': 149},  # Not in positions
    # {'symbol': 'ZVRA', 'breakout_date': '2026-06-08', 'stop_loss': 10.35, 'entry_id': 150},  # Not in positions
    # {'symbol': 'DLTH', 'breakout_date': '2026-06-08', 'stop_loss': 3.35, 'entry_id': 151},  # Not in positions
    # {'symbol': 'SUNE', 'breakout_date': '2026-06-08', 'stop_loss': 2.1, 'entry_id': 152},  # Not in positions
    # {'symbol': 'ALVO', 'breakout_date': '2026-06-08', 'stop_loss': 3.6, 'entry_id': 153},  # Not in positions
    # {'symbol': 'SFIX', 'breakout_date': '2026-06-11', 'stop_loss': 3.75, 'entry_id': 154},  # Not in positions
    # {'symbol': 'TEO', 'breakout_date': '2026-06-11', 'stop_loss': 14.4, 'entry_id': 155},  # Not in positions
    # {'symbol': 'BTQ', 'breakout_date': '2026-06-15', 'stop_loss': 4.3, 'entry_id': 156},  # Not in positions
    # {'symbol': 'SMWB', 'breakout_date': '2026-06-15', 'stop_loss': 4.35, 'entry_id': 157},  # Not in positions
    # {'symbol': 'HQ', 'breakout_date': '2026-06-15', 'stop_loss': 11.1, 'entry_id': 158},  # Not in positions
    # {'symbol': 'VNCE', 'breakout_date': '2026-06-16', 'stop_loss': 4.9, 'entry_id': 159},  # Not in positions
    # {'symbol': 'RRGB', 'breakout_date': '2026-06-16', 'stop_loss': 5.0, 'entry_id': 160},  # Not in positions
    # {'symbol': 'BFLY', 'breakout_date': '2026-06-18', 'stop_loss': 6.0, 'entry_id': 161},  # Not in positions
    # {'symbol': 'PRTH', 'breakout_date': '2026-06-18', 'stop_loss': 6.3, 'entry_id': 162},  # Not in positions
    # {'symbol': 'CDNA', 'breakout_date': '2026-06-18', 'stop_loss': 23.45, 'entry_id': 163},  # Not in positions
    {'symbol': 'EXFY', 'breakout_date': '2026-06-18', 'stop_loss': 1.2, 'entry_id': 164},  # Not in positions
    # {'symbol': 'TDUP', 'breakout_date': '2026-06-18', 'stop_loss': 5.0, 'entry_id': 165},  # Not in positions
    # {'symbol': 'GANX', 'breakout_date': '2026-06-29', 'stop_loss': 1.75, 'entry_id': 166},  # Not in positions
    # {'symbol': 'JACK', 'breakout_date': '2026-06-29', 'stop_loss': 13.2, 'entry_id': 167},  # Not in positions
    # {'symbol': 'QDEL', 'breakout_date': '2026-06-29', 'stop_loss': 15.0, 'entry_id': 168},  # Not in positions
    # {'symbol': 'GRND', 'breakout_date': '2026-07-01', 'stop_loss': 14.0, 'entry_id': 169},  # Not in positions
    # {'symbol': 'ADAG', 'breakout_date': '2026-07-01', 'stop_loss': 3.9, 'entry_id': 170},  # Not in positions
    # {'symbol': 'SLDE', 'breakout_date': '2026-07-02', 'stop_loss': 19.7, 'entry_id': 171},  # Not in positions
    # {'symbol': 'RIVN', 'breakout_date': '2026-07-02', 'stop_loss': 17.3, 'entry_id': 172},  # Not in positions
    # {'symbol': 'BVS', 'breakout_date': '2026-07-06', 'stop_loss': 10.4, 'entry_id': 173},  # Not in positions
    # {'symbol': 'CRTO', 'breakout_date': '2026-07-06', 'stop_loss': 19.0, 'entry_id': 174},  # Not in positions
    # {'symbol': 'FDUS', 'breakout_date': '2026-07-06', 'stop_loss': 19.3, 'entry_id': 175},  # Not in positions
    # {'symbol': 'AGEN', 'breakout_date': '2026-07-13', 'stop_loss': 4.85, 'entry_id': 176},  # Not in positions
    # {'symbol': 'QTTB', 'breakout_date': '2026-07-13', 'stop_loss': 17.0, 'entry_id': 177},  # Not in positions
    # {'symbol': 'GPRE', 'breakout_date': '2026-07-17', 'stop_loss': 17.2, 'entry_id': 178},  # Not in positions
    # {'symbol': 'PESI', 'breakout_date': '2026-07-17', 'stop_loss': 14.5, 'entry_id': 179},  # Not in positions
    # {'symbol': 'SBRA', 'breakout_date': '2026-07-21', 'stop_loss': 19.5, 'entry_id': 180},  # Not in positions
    # {'symbol': 'GREE', 'breakout_date': '2026-07-21', 'stop_loss': 2.0, 'entry_id': 181},  # Not in positions
    # {'symbol': 'AMTB', 'breakout_date': '2026-07-24', 'stop_loss': 25.75, 'entry_id': 182},  # Not in positions
    # {'symbol': 'GEHC', 'breakout_date': '2026-07-29', 'stop_loss': 64.0, 'entry_id': 183},  # Not in positions
    # {'symbol': 'CLW', 'breakout_date': '2026-07-29', 'stop_loss': 17.5, 'entry_id': 184},  # Not in positions
    # {'symbol': 'BLKB', 'breakout_date': '2026-07-29', 'stop_loss': 33.0, 'entry_id': 185},  # Not in positions
    # {'symbol': 'EXLS', 'breakout_date': '2026-07-29', 'stop_loss': 30.0, 'entry_id': 186},  # Not in positions
    # {'symbol': 'DXCM', 'breakout_date': '2026-07-31', 'stop_loss': 76.0, 'entry_id': 187},  # Not in positions
    # {'symbol': 'PGY', 'breakout_date': '2026-07-31', 'stop_loss': 17.0, 'entry_id': 188},  # Not in positions
    # {'symbol': 'AMCX', 'breakout_date': '2026-07-31', 'stop_loss': 9.5, 'entry_id': 189},  # Not in positions
    # {'symbol': 'XGN', 'breakout_date': '2026-08-04', 'stop_loss': 5.5, 'entry_id': 190},  # Not in positions
    # {'symbol': 'TPG', 'breakout_date': '2026-08-04', 'stop_loss': 46.2, 'entry_id': 191},  # Not in positions
    # {'symbol': 'OABI', 'breakout_date': '2026-08-07', 'stop_loss': 2.25, 'entry_id': 192},  # Not in positions
    {'symbol': 'PUBM', 'breakout_date': '2026-08-07', 'stop_loss': 15.0, 'entry_id': 193},
    # {'symbol': 'MTW', 'breakout_date': '2026-08-07', 'stop_loss': 15.0, 'entry_id': 194},  # Not in positions
    # {'symbol': 'QNST', 'breakout_date': '2026-08-07', 'stop_loss': 18.0, 'entry_id': 195},  # Not in positions
    # {'symbol': 'SPT', 'breakout_date': '2026-08-07', 'stop_loss': 9.0, 'entry_id': 196},  # Not in positions
    {'symbol': 'EXFY', 'breakout_date': '2026-08-07', 'stop_loss': 2.0, 'entry_id': 197},
    {'symbol': 'FLR', 'breakout_date': '2026-08-07', 'stop_loss': 50.0, 'entry_id': 198},
    # {'symbol': 'ABCL', 'breakout_date': '2026-08-10', 'stop_loss': 7.5, 'entry_id': 199},  # Not in positions
    {'symbol': 'BMRN', 'breakout_date': '2026-08-10', 'stop_loss': 61.5, 'entry_id': 200},
    {'symbol': 'NESR', 'breakout_date': '2026-08-10', 'stop_loss': 29.5, 'entry_id': 201},
    # {'symbol': 'QMCO', 'breakout_date': '2026-08-11', 'stop_loss': 13.0, 'entry_id': 202},  # Not in positions
    # {'symbol': 'SEPN', 'breakout_date': '2026-08-11', 'stop_loss': 38.5, 'entry_id': 203},  # Not in positions
    # {'symbol': 'STIM', 'breakout_date': '2026-08-11', 'stop_loss': 2.5, 'entry_id': 204},  # Not in positions
    # {'symbol': 'NIQ', 'breakout_date': '2026-08-11', 'stop_loss': 12.5, 'entry_id': 205},  # Not in positions
    # {'symbol': 'MASS', 'breakout_date': '2026-08-11', 'stop_loss': 8.75, 'entry_id': 206},  # Not in positions
    # {'symbol': 'CURI', 'breakout_date': '2026-08-13', 'stop_loss': 3.0, 'entry_id': 207},  # Not in positions
    # {'symbol': 'AVAH', 'breakout_date': '2026-08-13', 'stop_loss': 9.0, 'entry_id': 208},  # Not in positions
    {'symbol': 'SY', 'breakout_date': '2026-08-31', 'stop_loss': 2.3, 'entry_id': 209},
    {'symbol': 'SLB', 'breakout_date': '2026-08-31', 'stop_loss': 54.5, 'entry_id': 210},
    {'symbol': 'CHPT', 'breakout_date': '2026-09-03', 'stop_loss': 5.0, 'entry_id': 211},
    {'symbol': 'ABM', 'breakout_date': '2026-09-08', 'stop_loss': 45.5, 'entry_id': 212},
]
