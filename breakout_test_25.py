        ...
        if symbol not in existing_position_symbols:
            ...
            if symbol not in existing_order_symbols:
                ...
                # Model_01E: 60m_MACD cross up 0-line (LAB 1 Mar (10:30-11:30))
                    ...
                    # Significant Cross-up Factor 60m (LAB 1 Mar 2024: H_60m_C0(10:30) = 0.0163 > H_60m_P1(11:30) = 0.0063 --> SCF = 2.59)
                    SCF_60m_01E = round(H_60m_P1/H_60m_P1, decimal_point)         
                    SCF_60m_01E_threshold = 1.20
                    ...
                    if SCF_60m_01E > SCF_60m_01E_threshold and M_15m_C0 > M_15m_P1 > 0.0000 and H_15m_C0 > H_15m_P1 > 0.0000 and C_15m_C0 > C_15m_P1 and C_15m_C0 > O_15m_C0:
                        ...
                        # Significant Cross-up Factor 15m (LAB 1 Mar 2024: H_60m_C0(11:30) = 0.0160 > H_60m_P1(11:15) = 0.0129 --> SBF = 1.24)
                        ...
                        if SBF_15m_01E_01 > SBF_15m_01E_01_threshold and M_5m_C0 > M_5m_P1 > 0.0000:
