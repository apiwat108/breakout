    ...
    if symbol not in existing_position_symbols:
        ...
        if M_60m_P1 > 0 and M_60m_P1 > M_60m_P2 and M_60m_P2 > M_60m_P3:
            if M_15m_P1 > 0 and H_15m_P1 > limit and H_15m_P2 > limit and H_15m_P3 > limit: 
                if H_5m_P1 > 0.01 and H_5m_P2 < 0 and H_5m_C0 > H_5m_P1 > H_5m_P2:
        ...
        # Strategy 2
            ...
            if M_5m_C0 < 0 and H_5m_C0 > H_5m_P1 > H_5m_P2 > 0 and H_5m_P3 < 0 and closes_5m[-1] > E_5m_C0:
        ...
        if (0 < H_5m_C0 < H_5m_P1 < H_5m_P2 and H_5m_P2 > H_5m_P3 and M_5m_P2 > 0 and S_5m_P3 > 0) or (market_price > (1.005 * entry_price)):
