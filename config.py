...
BREAKOUT_SYMBOLS_5MX0_AB = ['MARA', 'ENVX', 'ZVRA', 'NB', 'RCI', 'SNAP', 'SLI', 'BLCO', 'GTN', 'QS', 'U', 'STGW', 'BTCS', 'PDYN', 'JMIA', 'AMLX', 'GAME', 'SY', 'HUT', 'OPEN', 'SOUN', 'INVZ', 'WULF', 'UAVS', 'WBD', 'KODK', 'AMBC', 'AGEN', 'METC', 'IE', 'FFAI', 'PRME', 'UEC', 'SNDL', 'PGNY', 'ABAT', 'BKSY', 'VNET', 'GOSS', 'WT', 'AMPX', 'QTTB', 'POET', 'AAL', 'GSAT', 'LAR', 'LWLG', 'NEXT', 'GLXY', 'ACHR', 'CIFR', 'ASPN', 'ZURA', 'VERI', 'LEVI', 'UMAC', 'HIVE', 'MLCO', 'PLL', 'RGTI', 'BMBL', 'UUUU', 'ODV', 'BEEM', 'DK', 'RMNI', 'PLUG', 'LAC', 'PBI']