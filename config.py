...
BREAKOUT_SYMBOLS_5MX0_AB = ['DNN', 'APLT', 'NTLA', 'NFGC', 'TLRY', 'PLUG', 'AQST', 'BTU', 'CLPT', 'ABAT', 'BTDR', 'CLSK', 'AMPX', 'QMCO', 'PL', 'NXE', 'CENX', 'BLDP', 'NRGV', 'FATE', 'TE', 'EYE', 'AG', 'LAC', 'RLAY', 'CDE', 'HAL', 'LTBR', 'SES', 'SAVA', 'ARQT', 'FLNC', 'OCGN', 'ZURA', 'QBTS', 'ANNX', 'ARWR', 'PONY', 'SLI', 'BFLY', 'PEPG', 'RGTI']