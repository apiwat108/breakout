...
BREAKOUT_SYMBOLS_5MX0_AB = ['BKR', 'SEI', 'HOMB', 'CAE', 'LIND', 'FLYW', 'CTRI', 'BTCT', 'VTRS', 'NPWR', 'TFC', 'FFBC', 'AAOI', 'ZVIA', 'SLM', 'HBAN', 'CAN', 'GRNT', 'SGHC', 'WBD', 'GEO', 'CFLT', 'RF', 'RELY', 'RIGL', 'MDXG', 'ARIS', 'AIOT', 'FULT', 'HNST', 'CDXC', 'GABC', 'FHN', 'RCAT', 'WWW', 'BLND', 'DESP', 'ET', 'WRBY', 'AMTX', 'WSBC', 'ANY', 'AMPX', 'CFG', 'ATAI', 'KAR', 'UCB', 'BKU', 'QBTS', 'KOD', 'HNRG']
