...
BREAKOUT_SYMBOLS_5MX0_AB = ['HOUS', 'AMPY', 'WT', 'UEC', 'BMBL', 'RCI', 'ASPI', 'ABAT', 'IVZ', 'WOOF', 'NB', 'FFAI', 'LAR', 'BLNE', 'KODK', 'IE', 'LAC', 'CIFR', 'BYON', 'LWLG', 'JMIA', 'BTU', 'UUUU', 'METC', 'AMLX', 'GLXY', 'ABSI', 'SNAP', 'BTCS', 'VNET', 'WBD', 'RF', 'ASPN', 'RGTI', 'PLUG', 'AMBC', 'CDLX', 'IOVA', 'REAL', 'CLF', 'BYND', 'VERI', 'CHGG', 'XRX', 'GPRO', 'AMPX', 'SNDL', 'ABR', 'SY', 'U', 'AVXL', 'DNUT', 'OPEN', 'QS', 'EAF', 'GOSS', 'UAVS', 'NEXT', 'STGW', 'BITF', 'HIVE', 'PDYN', 'PBI', 'INVZ']