...
BREAKOUT_SYMBOLS_5MX0_AB = ['ABAT', 'SAVA', 'RGTI', 'TMC', 'QBTS', 'LAC', 'CENX', 'ORIC', 'KOPN', 'WTI', 'CAN', 'NTLA', 'ABCL', 'TE', 'CLSK', 'CATX', 'NVTS', 'NPWR', 'PLUG', 'ASPI', 'CLF', 'LAR', 'ARQT', 'AQST', 'RLAY', 'QSI', 'ZURA', 'POET', 'SLDP', 'AG', 'BTU', 'ELBM', 'LTBR', 'GWH', 'NXL', 'TLRY', 'PATH', 'IE', 'APLT', 'FLNC', 'BFLY', 'NFGC', 'BLDP', 'SES', 'PL', 'LAES', 'FATE', 'SLI', 'SERV', 'INVZ']