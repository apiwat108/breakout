...
BREAKOUT_SYMBOLS_5MX0_AB = ['BOXL', 'SGMT', 'NAOV', 'MBOT', 'FUBO', 'IRBT', 'PLUG', 'AVO', 'POET', 'TEVA', 'RUM', 'AVXL', 'ABAT', 'PLYA', 'CMRX', 'SKYT', 'LABD', 'SES', 'NITO', 'NFE', 'SRFM', 'CTM', 'RR', 'AIRE', 'HTCR', 'DRCT']

# Already passed 60MX0 (10 Dec 2024)
# ['GFAI', 'BARK', 'ASAN', 'PATH', 'GRRR', 'VUZI', 'RXRX', 'CRNC']
# ['MGX', 'ANGO', 'GRRR', 'BB', 'SSRM', 'UGI', 'DAKT', 'NVCR', 'KD']