...
BREAKOUT_SYMBOLS_5MX0_AB = ['LUMN', 'IMAX', 'GRND', 'GTES', 'AKBA', 'WSBC', 'GRNT', 'ZVIA', 'ASTE', 'AEYE', 'PBI', 'FFBC', 'ADEA', 'ACCO', 'LZ', 'RELY', 'KOD', 'SOUN', 'FULT', 'QBTS', 'NBBK', 'LIND', 'AAOI', 'GABC', 'CAN', 'PINC', 'BKR', 'HFWA', 'MDXG', 'KMT', 'BLND', 'WWW', 'FHB', 'RIGL', 'ASB']
