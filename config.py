...
BREAKOUT_SYMBOLS_5MX0_AB = ['WULF', 'LEVI', 'SNAP', 'AMLX', 'TDOC', 'DK', 'ODV', 'UMAC', 'SOUN', 'GTN', 'BTCS', 'BKSY', 'AGEN', 'QS', 'SY', 'JMIA', 'CIFR', 'PGNY', 'AAL', 'VIAV', 'BMBL', 'IE', 'AMPX', 'UUUU', 'FHB', 'NEXT', 'KAR', 'NAVI', 'PBI', 'ABCL', 'SLI', 'MARA', 'ASPN', 'HUT', 'PRME', 'HIVE', 'GAME', 'GSAT', 'POET', 'LAR', 'AMTX', 'SNDL', 'RMNI', 'PACB', 'BLMN', 'CAE', 'SLNH', 'ADNT', 'ZVRA', 'MUX', 'ENVX', 'UAVS', 'RCI', 'VNET', 'ACI', 'BLCO', 'WT', 'U', 'INVZ', 'KODK', 'MLCO', 'QTTB', 'PLUG']