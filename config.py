...
BREAKOUT_SYMBOLS_5MX0_AB = ['EQX', 'WULF', 'BTBT', 'ASPN', 'VXRT', 'SBH', 'RBRK', 'BSAC', 'ESTA', 'IOVA', 'BSTZ', 'MUX', 'U', 'LEVI', 'DT', 'MGNI', 'FNKO', 'DOCN', 'GLBE', 'OPRA', 'BCH', 'ABSI', 'OPEN', 'RCUS', 'AKRO', 'FLNC', 'PPTA']
