...
BREAKOUT_SYMBOLS_5MX0_AB = ['AQST', 'HR', 'DBRG', 'RLAY', 'MUX', 'EQX', 'ARWR', 'SONO', 'RGTI', 'BTDR', 'BTSG', 'AEO', 'HIVE', 'TSHA', 'AG', 'CC', 'HUT', 'KGC', 'CDP', 'HL', 'M', 'LION', 'OLMA', 'MIR', 'ROIV', 'CDE', 'RCAT', 'LDI', 'AGNC', 'BTU', 'MPW', 'CENX', 'GAU', 'TE', 'CLM', 'WBD', 'GRAB', 'BORR', 'JAMF', 'TVTX', 'PL', 'KOPN']