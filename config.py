...
BREAKOUT_SYMBOLS_5MX0_AB =   ['PBI', 'HEPS', 'LGVN', 'PEGY', 'ERAS', 'ERJ', 'NBBK', 'ESRT', 'CCL', 'NKTR', 'PLSE', 'JMIA', 'SYF', 'MNKD', 'EXLS', 'LAUR', 'CIM', 'JOBY', 'HIMX', 'QURE', 'NYCB', 'CDP', 'CUK', 'MYO', 'SLRN', 'EVGO', 'ADPT', 'GLW', 'ENVX', 'AAN', 'MRC', 'ESI', 'NBTB', 'VRRM', 'BTBT', 'SNAP', 'BFH', 'AEHR', 'TVTX', 'RVMD', 'APEI', 'LC']
