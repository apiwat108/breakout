...
BREAKOUT_SYMBOLS_5MX0_AB = ['TVTX', 'HAL', 'QMCO', 'SAVA', 'HUT', 'AG', 'QBTS', 'PONY', 'LTBR', 'PLUG', 'CENX', 'CDP', 'PL', 'HIVE', 'ARWR', 'DBRG', 'GRAB', 'PAGS', 'SES', 'BFLY', 'ROIV', 'BLDP', 'AQST', 'CLSK', 'NRGV', 'WRD', 'BTDR', 'REKR', 'BTSG', 'HL', 'RR', 'BTE', 'RGTI', 'WBD', 'CDE', 'DNN', 'RCAT', 'BRY', 'JAMF', 'RLAY', 'FSLY', 'AMPX', 'OCGN', 'SERV', 'EYE', 'MIR', 'NTLA', 'UPWK', 'NXE', 'BLNE', 'KOPN', 'QUBT', 'BTU', 'MPW']