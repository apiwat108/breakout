...
BREAKOUT_SYMBOLS_5MX0_AB = ['CTRI', 'GERN', 'MNRO', 'EYPT', 'BORR', 'VLY', 'CLYM', 'RF', 'PTEN', 'AHCO', 'NEOG', 'ABUS', 'FNB', 'DBI', 'LEG', 'AROC', 'HOPE', 'CGC', 'CADL', 'CRON', 'OCUL', 'LION', 'HLF', 'IMMX', 'COLB', 'AMTM', 'FOLD', 'ARTV', 'VNDA', 'OGI', 'ASTI', 'DC', 'WRBY', 'BGS', 'WU']
