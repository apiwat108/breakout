...
BREAKOUT_SYMBOLS_5MX0_AB = ['HL', 'LION', 'KOPN', 'RR', 'CENX', 'JAMF', 'REKR', 'AGNC', 'BTE', 'ARWR', 'CC', 'TVTX', 'AQST', 'WBD', 'BRY', 'SONO', 'BTSG', 'HR', 'RCAT', 'RLAY', 'NXE', 'AG', 'DBRG', 'FSLY', 'PAGS', 'BTDR', 'AEO', 'M', 'HUT', 'MPW', 'BTU', 'APA', 'MUX', 'ROIV', 'GRAB', 'MIR', 'OLMA', 'EQX', 'KGC', 'BLNE', 'PL', 'CDE', 'OCGN', 'CDP', 'LDI', 'DNN', 'RGTI', 'HIVE']