...
BREAKOUT_SYMBOLS_5MX0_AB = ['ABAT', 'JAMF', 'SLI', 'PLUG', 'GRAB', 'EYE', 'PAGS', 'CLSK', 'DNN', 'LRMR', 'DBRG', 'BTU', 'OCGN', 'QMCO', 'NRGV', 'BLDP', 'AMPX', 'HIVE', 'LAC', 'QBTS', 'WBD', 'ROIV', 'CENX', 'NXE', 'WRD', 'LTBR', 'AQST', 'SERV', 'SES', 'FLNC', 'PEPG', 'RGTI', 'NTLA', 'ARWR', 'RR', 'BFLY', 'TE', 'CDE', 'PONY', 'BTDR', 'UPWK', 'BLNE', 'FSLY', 'QUBT', 'BRY', 'HUT', 'PL', 'REKR', 'AG', 'CLPT', 'RLAY', 'HAL', 'BTE', 'SAVA', 'RCAT']