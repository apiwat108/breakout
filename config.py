...
BREAKOUT_SYMBOLS_5MX0_AB = ['KAR', 'TFC', 'HNST', 'NPWR', 'UAA', 'WWW', 'DESP', 'ET', 'CAE', 'RCAT', 'CDXC', 'KOD', 'IMAX', 'FFBC', 'AAOI', 'UCB', 'SEI', 'GEO', 'BKU', 'HFWA', 'ARIS', 'CAN', 'GRNT', 'QBTS', 'LIND', 'ASTE', 'WSBC', 'HNRG', 'WRBY', 'ZVIA', 'GTES', 'FHN', 'CFLT', 'RF', 'BTCT', 'VTRS', 'HBAN', 'AMPX', 'BITF', 'BKR', 'AMTX', 'SGHC', 'SLM', 'CTRI', 'ACCO', 'AIOT', 'RELY', 'PINC', 'HOMB', 'WBD', 'RIGL', 'CFG', 'ANY', 'GABC', 'BLND', 'MDXG', 'FLYW', 'ATAI', 'FULT']
