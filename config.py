...
BREAKOUT_SYMBOLS_5MX0_AB = ['OCGN', 'LDI', 'TVTX', 'DBRG', 'KOPN', 'LION', 'M', 'DNN', 'JAMF', 'CDE', 'HR', 'HIVE', 'ARWR', 'BRY', 'FSLY', 'CC', 'HL', 'SONO', 'AEO', 'RR', 'CLM', 'GRAB', 'BTSG', 'BTDR', 'RGTI', 'AQST', 'HUT', 'BLNE', 'MIR', 'BTU', 'MPW', 'CENX', 'MUX', 'PL', 'OLMA', 'AGNC', 'NXE', 'RCAT', 'EQX', 'KGC', 'WBD', 'CDP', 'RLAY', 'AG', 'ROIV', 'REKR']
