...
BREAKOUT_SYMBOLS_5MX0_AB = ['CC', 'ATEN', 'NTST', 'RWT', 'AM', 'TK', 'PTEN', 'KRG', 'WU', 'FULT', 'NMRA', 'BORR', 'LGO', 'CNH', 'MITK', 'XIFR', 'PCG', 'RIG', 'HLMN', 'KVUE', 'KOS', 'FSLY', 'BAK', 'AES', 'KMI', 'WULF', 'UAA', 'HUN', 'BGS', 'GTES', 'NVST', 'VNET', 'QXO', 'KPTI', 'SFL', 'SUZ', 'SBLK', 'HCSG']
