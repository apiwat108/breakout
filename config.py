...
BREAKOUT_SYMBOLS_5MX0_AB = ['RLAY', 'ABAT', 'PAGS', 'SLI', 'BTE', 'JAMF', 'OCGN', 'CLSK', 'SERV', 'PL', 'HIVE', 'DBRG', 'BFLY', 'FLNC', 'AG', 'UPWK', 'RGTI', 'AMPX', 'TE', 'CDE', 'NTLA', 'QUBT', 'DNN', 'BLDP', 'BTDR', 'PEPG', 'RCAT', 'HUT', 'LRMR', 'RR', 'PLUG', 'PONY', 'QBTS', 'LTBR', 'ARWR', 'KOPN', 'QMCO', 'FSLY', 'WBD', 'BLNE', 'NRGV', 'SES', 'MPW', 'LAC', 'REKR', 'CENX', 'BTU', 'HAL', 'TVTX', 'GRAB', 'EYE', 'NXE', 'SAVA', 'BRY', 'WRD', 'CLPT', 'AQST', 'ROIV']