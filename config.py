...
BREAKOUT_SYMBOLS_5MX0_AB = ['IE', 'FATE', 'ERIC', 'CLSK', 'SANA', 'TE', 'QSI', 'KOPN', 'NNDM', 'RGTI', 'BTDR', 'LTBR', 'NTLA', 'BLDP', 'PATH', 'INDI', 'SAVA', 'WTI', 'FLNC', 'SLDP', 'CAN', 'RCKT', 'DBRG', 'ABSI', 'VERI', 'RXRX', 'GWH', 'CENX', 'NVTS', 'AQST', 'IRBT', 'LBRT', 'AG', 'APLT', 'ARQT', 'LAES', 'SES', 'CATX', 'CCO', 'ORLA', 'QBTS', 'RLAY']