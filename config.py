...
BREAKOUT_SYMBOLS_5MX0_AB = ['EGO', 'VCYT', 'SHIP', 'PAYO', 'PENN', 'ALDX', 'FF', 'ENB', 'PAY', 'FUBO', 'IAG', 'CLNE', 'VTEX', 'DOCN', 'U', 'VMEO', 'FOLD', 'ORGN', 'CHWY', 'TGTX', 'NGD', 'UMC', 'HAYW', 'VSCO', 'IMVT', 'ARMK', 'UGP', 'DOMO', 'APPS', 'ITUB', 'RBRK', 'SU', 'WULF', 'DT', 'YPF', 'STKL', 'ABEV', 'CSTL', 'GSAT', 'VRAX', 'BTBT', 'SKE', 'AMH', 'DAR', 'XP', 'CNQ', 'SKYT', 'ELAN', 'UTZ', 'EXFY', 'SG', 'STNE', 'GGAL', 'RKLB', 'LUNR', 'YUMC', 'OGI', 'UAA', 'PBI', 'SUPV']
