...
BREAKOUT_SYMBOLS_5MX0_AB = ['NXE', 'KOPN', 'DBRG', 'AMPX', 'GRAB', 'OCGN', 'WBD', 'FSLY', 'BTU', 'LDI', 'AQST', 'CDP', 'DNN', 'APA', 'CC', 'TVTX', 'M', 'PL', 'BTE', 'HUT', 'CENX', 'RLAY', 'BLNE', 'PAGS', 'ROIV', 'MIR', 'HIVE', 'RGTI', 'MUX', 'AG', 'LION', 'SONO', 'REKR', 'RR', 'BTDR', 'HL', 'RCAT', 'BLDP', 'MPW', 'ARWR', 'CDE', 'QBTS', 'JAMF', 'EQX', 'BRY', 'AEO', 'PLUG', 'BTSG']