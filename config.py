...
BREAKOUT_SYMBOLS_5MX0_AB = ['DNA', 'MVST', 'PLAY', 'MOMO', 'OUST', 'WT', 'QTRX', 'UROY', 'EDIT', 'SA', 'FCEL', 'BLMN', 'CRML', 'TGB', 'BTE', 'GRRR', 'ADNT', 'PHUN', 'CRSR', 'ABCL', 'QUBT', 'DGXX', 'TSSI', 'PHAT', 'MANU', 'PBF', 'CHGG', 'ALT', 'DNN', 'AMTX', 'PACB', 'TE']
