...
BREAKOUT_SYMBOLS_5MX0_AB = ['BLNE', 'WBD', 'IOVA', 'STGW', 'IVZ', 'GPRO', 'CLF', 'ASPI', 'COUR', 'ASPN', 'LAR', 'OPEN', 'ABR', 'BTU', 'EAF', 'UUUU', 'XRX', 'REAL', 'UEC', 'BYON', 'RF', 'LWLG', 'DNUT', 'GLXY', 'BMBL', 'HOUS', 'BITF', 'GOSS', 'UAVS']