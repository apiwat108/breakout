...
BREAKOUT_SYMBOLS_5MX0_AB = ['LXRX', 'APEI', 'BHVN', 'ADTN', 'GES', 'DOMO', 'GT', 'SLN', 'RVMD', 'INO', 'VYX', 'FDL', 'UNIT', 'APA', 'PPC', 'GLPI', 'MREO', 'ACB', 'XLRE', 'SOFI', 'NBBK', 'MATV', 'NNN', 'FHN', 'IMXI', 'XERS', 'CPB', 'TELL', 'MCW', 'CDP', 'ONON', 'WTTR', 'EB', 'ALLO', 'MRVI', 'ATXS', 'ERAS', 'PDCO', 'ESRT', 'JAMF', 'NBTB', 'CMAX', 'IONS', 'SLRN', 'ARI', 'RUM', 'BFH', 'OPEN', 'ITOS', 'CTKB', 'ADPT', 'PPBI', 'COMP', 'VRRM', 'OR', 'DOCS', 'KNSA', 'BZH', 'CNNE', 'ASTH', 'MRC', 'GH', 'FYBR', 'VICI', 'EXLS', 'AEHR', 'CLBT', 'VLY', 'LC', 'KIM', 'KYMR', 'AVDL', 'AUTL', 'CHX', 'IGR', 'ASTL', 'BLND', 'WBD', 'RDFN', 'NKTR']
