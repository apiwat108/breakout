...
BREAKOUT_SYMBOLS_5MX0_AB = ['PLG', 'LE', 'OSS', 'ACRS', 'MAIA', 'DNLI', 'CRVS', 'GLDD', 'FULT', 'SBLK', 'PTEN', 'CHRS', 'IBRX', 'AXL', 'CMBT', 'CRML', 'EC', 'DAWN', 'ERAS', 'IPSC', 'EGY', 'NEOG', 'ARDX', 'TWO', 'BAER', 'TYGO', 'KMI', 'UMC']
