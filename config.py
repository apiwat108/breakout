...
BREAKOUT_SYMBOLS_5MX0_AB = ['SID', 'OCGN', 'IOTR', 'LIND', 'DAWN', 'AXL', 'CMPS', 'ZNTL', 'CMBT', 'VLN', 'NEOG', 'PTEN', 'LUNR', 'UMC', 'IPSC', 'SBLK', 'CRML', 'ERAS', 'AEVA', 'RKT', 'IHS', 'DDL', 'IBRX', 'CDZI', 'FBIO', 'ARDX', 'EC', 'BAER', 'OLPX', 'ZETA', 'VNET', 'CERS', 'TWO', 'OSS']
