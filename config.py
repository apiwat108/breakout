...
BREAKOUT_SYMBOLS_5MX0_AB = ['MANU', 'MOMO', 'HUT', 'CHGG', 'AMTX', 'TME', 'EDIT', 'CRSR', 'TSSI', 'BTSG', 'QUBT', 'ZVRA', 'BEN', 'GRRR', 'FULC', 'AIFF', 'SA', 'TUYA', 'TSLX', 'MATH', 'PBI', 'DOMO', 'UDMY', 'TGB', 'INZY', 'FATE', 'PHAT', 'FCEL']