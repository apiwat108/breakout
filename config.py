...
BREAKOUT_SYMBOLS_5MX0_AB = ['BGS', 'WU', 'MITK', 'KPTI', 'RWT', 'LGO', 'SBLK', 'BORR', 'ATOM', 'QXO', 'RIME', 'VNET', 'FSLY', 'BAK', 'SUZ', 'SFL', 'CNH', 'UAA', 'NVST', 'CC', 'PCG', 'HUN', 'WULF', 'GTES', 'ATEN', 'NTST', 'FULT', 'NMRA', 'PTEN', 'AM', 'KOS', 'KRG', 'KVUE', 'AES', 'KMI', 'RIG', 'XIFR']
