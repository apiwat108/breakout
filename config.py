...
BREAKOUT_SYMBOLS_5MX0_AB = ['PCG', 'RELY', 'KVUE', 'XPRO', 'KMI', 'AGIG', 'XP', 'WTI', 'TALK', 'GOOD', 'MCW', 'SWIM', 'RWT', 'LBTYA', 'MPT', 'SUZ', 'GTES', 'AM', 'SFL', 'XIFR', 'MITK', 'CNH', 'NMRA', 'NTST', 'KOS', 'UAA', 'RIG', 'SBLK', 'NVST', 'CGEM', 'BORR', 'AES', 'FSLY', 'GERN', 'QXO', 'LBTYK', 'BGS', 'KRG', 'RIME', 'ATOM']
