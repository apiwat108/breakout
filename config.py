...
BREAKOUT_SYMBOLS_5MX0_AB = ['BAER', 'EC', 'UMC', 'OSS', 'DAWN', 'FULT', 'TWO', 'EGBN', 'PLG', 'NEOG', 'PTEN', 'AVIR', 'CRVS', 'ZNTL', 'ARDX', 'VLN', 'EGY', 'LODE', 'MAIA', 'CERS', 'CMBT', 'ACRS', 'CRML', 'CHRS', 'DNLI', 'AXL', 'IBRX', 'GLDD', 'SBLK', 'TYGO', 'CMPS', 'ERAS', 'KMI', 'IPSC']
