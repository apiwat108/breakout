...
BREAKOUT_SYMBOLS_5MX0_AB = ['CMP', 'GRND', 'HOOD', 'OCUL', 'WSR']

# BREAKOUT_SYMBOLS_5MX0_AB = ['ZURA', 'MTTR', 'WSR', 'MTA', 'GRND', 'MUX', 'EWTX', 'IONQ', 'ABOS', 'HUT', 'TDS', 'LASR', 'SLV', 'CMP', 'AI', 'BLZE', 'VERI', 'BTG', 'LC', 'GTES', 'ERII', 'AEVA', 'MDU', 'GNW', 'AIOT', 'WW', 'BW', 'OCUL', 'ALKT', 'QUBT', 'NCV', 'MIR', 'UNFI', 'CUE', 'LAC', 'LAAC', 'NYCB', 'PAAS', 'SA', 'INFA', 'NOK', 'RGTI', 'SOFI', 'HIVE', 'OPFI', 'EOS', 'HOOD', 'TWG', 'VITL', 'VLRS', 'QBTS', 'SLI', 'AMBP']
