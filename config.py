...
BREAKOUT_SYMBOLS_5MX0_AB = ['GTES', 'NVST', 'XP', 'TALK', 'AES', 'ABX', 'NMRA', 'QXO', 'WTI', 'AGIG', 'MITK', 'UAA', 'LBTYA', 'BORR', 'XPRO', 'SFL', 'SBLK', 'CGEM', 'RIG', 'FSLY', 'LBTYK', 'BGS', 'CNH', 'WULF', 'RELY', 'SUZ', 'VNET', 'KRG', 'ATOM', 'KMI', 'SWIM', 'GOOD', 'ASC', 'KVUE', 'MPT', 'CC', 'XIFR', 'GERN', 'AM', 'NTST', 'RWT', 'MCW', 'PCG', 'RIME', 'KOS']
...
# Entry by 60MX0 and 60H < 0 and 60PXU 0-line with 1D Price > EMA_10 (6.18%)