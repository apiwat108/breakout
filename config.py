...
BREAKOUT_SYMBOLS_5MX0_AB = ['RNAC', 'MTTR', 'KGS', 'INFA', 'UNFI', 'LASR', 'IONQ', 'YTRA', 'CMP', 'SLI', 'BW', 'AI', 'CPNG', 'SOFI', 'NCV', 'AIOT', 'KTOS', 'CART', 'LAAC', 'LAC', 'WW', 'GRND', 'HOOD', 'MDU', 'NYCB', 'MIR', 'VITL', 'WSR', 'GNW', 'REAL', 'TWG', 'OCUL', 'VERI', 'LC', 'EWTX', 'EOS', 'PTCT', 'ERII', 'BLZE']
