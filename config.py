...
BREAKOUT_SYMBOLS_5MX0_AB = ['SUPV', 'IAG', 'PAYO', 'ORGN', 'VCYT', 'CHWY', 'RKLB', 'SG', 'AMH', 'BCAB', 'FF', 'RBRK', 'YPF', 'STKL', 'VTEX', 'GGAL', 'VMEO', 'YUMC', 'ENB', 'TGTX', 'PLTR', 'SU', 'ELAN', 'APPS', 'UMC', 'CNQ', 'VSCO', 'CLNE', 'PAY', 'UTZ', 'FOLD', 'CSTL', 'ABEV', 'UGP', 'STNE', 'SKYT', 'DOMO', 'SHIP', 'XP', 'VERI', 'PENN', 'HAYW', 'DAR']
