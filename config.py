...
BREAKOUT_SYMBOLS_5MX0_AB = ['ASPN', 'BMBL', 'HUT', 'NB', 'WULF', 'MUX', 'NAVI', 'UMAC', 'AGEN', 'LEVI', 'AMTX', 'BTCS', 'POET', 'U', 'ENVX', 'PGNY', 'UUUU', 'PACB', 'ADNT', 'SLI', 'MARA', 'AAL', 'CAE', 'IE', 'PLUG', 'METC', 'VNET', 'CIFR', 'GTN', 'KODK', 'LAR', 'WT', 'AMLX', 'ODV', 'PRME', 'GSAT', 'RMNI', 'ZVRA', 'BLCO', 'PBI', 'SNDL', 'BKSY', 'RCI', 'SOUN', 'UAVS', 'HIVE', 'DK', 'SY', 'QTTB', 'QS', 'GAME', 'SNAP', 'AMPX', 'INVZ', 'NEXT', 'JMIA', 'MLCO']