...
BREAKOUT_SYMBOLS_5MX0_AB = ['SLDP', 'AAL', 'VIAV', 'LBRT', 'IRWD', 'AXGN', 'GCI', 'F', 'NOV', 'NOK', 'IMVT', 'CDNA', 'ACRS', 'TEVA', 'AVDL', 'DAWN', 'PUMP', 'ARQT', 'DYN', 'SUPV', 'GGB', 'MIR', 'VTRS', 'EBS', 'GPRK', 'TDC', 'RIG', 'LUMN', 'EWTX', 'MD', 'HAYW', 'CX', 'CSIQ', 'GDYN', 'DAN', 'NMRA']