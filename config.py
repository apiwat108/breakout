...
BREAKOUT_SYMBOLS_5MX0_AB = ['SOUN', 'GRND', 'BLND', 'WWW', 'IMAX', 'ALT', 'ANY', 'AAOI', 'KMT', 'BITF', 'PINC', 'AKBA', 'AEYE', 'FFBC', 'CDXC', 'GABC', 'CAN', 'RIGL', 'AMPX', 'ZVIA', 'WSBC', 'BTCT', 'NBBK', 'FULT', 'BKR', 'QBTS', 'ASB', 'GRNT', 'RELY', 'HFWA', 'LIND', 'AMTX', 'KOD', 'NPWR', 'MDXG', 'MARA', 'FHB', 'LUMN', 'ASTE', 'GTES', 'CFLT', 'LZ', 'ACCO']
