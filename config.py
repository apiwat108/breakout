...
BREAKOUT_SYMBOLS_5MX0_AB = ['SKYE', 'BUSE', 'HUT', 'FHB', 'ENVX', 'QTRX', 'KAR', 'SNAP', 'TDOC', 'SRI', 'MIND', 'SY', 'JMIA', 'SLI', 'AMTX', 'PLUG', 'IE', 'CIFR', 'SERA', 'BLCO', 'ABCL', 'HBM', 'NAVI', 'EB', 'VIAV', 'DNA', 'CTOR', 'RCI', 'CAE', 'OPRA', 'MUX', 'VNET', 'MLCO', 'AEHR', 'NU', 'UUUU', 'RZLV', 'ADPT', 'LAR', 'BBAI', 'AMLX', 'BKSY', 'BLMN', 'EXTR', 'ARBE', 'HIVE', 'WULF', 'PACB', 'GSAT', 'MGNI', 'TXG', 'QS', 'CRML', 'INVZ', 'CORZ', 'MARA', 'GTN', 'ACI', 'JHX', 'GEOS', 'U', 'BGC', 'ANNX', 'POET', 'NKTR', 'BMBL', 'WT', 'NEXT', 'PACS', 'ZVRA', 'ZETA', 'EVH', 'TWI', 'PRME', 'ONL', 'COMM', 'ADNT']