...
BREAKOUT_SYMBOLS_5MX0_AB = ['LAES', 'ARQT', 'BTU', 'NTLA', 'IE', 'TLRY', 'SES', 'SLI', 'PONY', 'ABCL', 'AMPX', 'ANNX', 'CENX', 'NXL', 'LAR', 'CAN', 'PL', 'TMC', 'LTBR', 'ARWR', 'NFGC', 'TE', 'RLAY', 'SLDP', 'CLSK', 'RGTI', 'CLPT', 'SATL', 'INVZ', 'POET', 'QMCO', 'QBTS', 'QUBT', 'AG', 'BANC', 'KOPN', 'BTDR', 'ZURA', 'APLT', 'FATE', 'ABAT', 'NPWR', 'AQST', 'BFLY', 'PEPG', 'FLNC', 'CLF', 'PLUG', 'LAC', 'ORIC', 'SAVA', 'OCGN', 'BLDP']