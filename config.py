...
BREAKOUT_SYMBOLS_5MX0_AB = ['QXO', 'CC', 'MITK', 'KRG', 'XIFR', 'KPTI', 'ATOM', 'NVST', 'LBTYK', 'GTES', 'ASC', 'MCW', 'SUZ', 'ATEN', 'FSLY', 'SFL', 'GERN', 'WULF', 'KVUE', 'LBTYA', 'BORR', 'KOS', 'AM', 'NMRA', 'PCG', 'RIME', 'ABX', 'BGS', 'RWT', 'KMI', 'RIG', 'AES', 'UAA', 'CNH', 'VNET', 'SBLK', 'NTST']
