...
BREAKOUT_SYMBOLS_5MX0_AB = ['RELI', 'TGB', 'SWBI', 'EDIT', 'MANU', 'VERV', 'CRK', 'TE', 'BTE', 'CCLD', 'MVST', 'APPS', 'QTRX', 'PACS', 'QUBT', 'ABCL', 'WT', 'TSSI', 'DNA', 'PBF', 'OUST', 'SA', 'UROY', 'DK', 'ADNT', 'BLMN', 'PLAY', 'DOMH', 'OSCR', 'MOMO', 'PACB', 'ALT', 'CRML', 'AMTX', 'DNN', 'INVZ', 'PHAT', 'GALT', 'BRY', 'DGXX']