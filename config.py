...
BREAKOUT_SYMBOLS_5MX0_AB = ['PACB', 'PRME', 'U', 'ASPN', 'WBD', 'LWLG', 'CIFR', 'GTN', 'RGTI', 'QTTB', 'HUT', 'VERI', 'AAL', 'OPEN', 'NB', 'UUUU', 'UAVS', 'ODV', 'PGNY', 'KODK', 'BLCO', 'PBI', 'LAR', 'QS', 'MLCO', 'LEVI', 'GLXY', 'ABAT', 'BTCS', 'GSAT', 'SNDL', 'AMPX', 'NEXT', 'UMAC', 'WULF', 'RMNI', 'CAE', 'ZVRA', 'ACHR', 'STGW', 'ENVX', 'UEC', 'SOUN', 'INVZ', 'JMIA', 'VNET', 'BMBL', 'AMLX', 'RCI', 'DK', 'SNAP', 'GOSS', 'POET', 'IE', 'METC', 'SY', 'AGEN', 'GAME', 'PLUG', 'WT', 'MARA', 'BKSY', 'HIVE', 'SLI']