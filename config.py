...
BREAKOUT_SYMBOLS_5MX0_AB = ['FF', 'ALDX', 'PBI', 'IOVA', 'DT', 'STKL', 'IAG', 'BBD', 'U', 'BTBT', 'ENB', 'ITUB', 'IMVT', 'SKE', 'UTZ', 'CNQ', 'VTEX', 'SUPV', 'DOCN', 'ORGN', 'GSAT', 'PENN', 'WULF', 'UGP', 'XP', 'FUBO', 'ARMK', 'RKLB', 'RBRK', 'BCAB', 'TGTX', 'NGD', 'CHWY', 'LUNR', 'AKRO']
