...
BREAKOUT_SYMBOLS_5MX0_AB = ['KOS', 'NMRA', 'SFL', 'KMI', 'WU', 'RIG', 'ATEN', 'SBLK', 'KRG', 'VNET', 'AM', 'ARCO', 'SUZ', 'WULF', 'CC', 'FULT', 'MITK', 'AES', 'HCSG', 'NVST', 'BGS', 'TK', 'LGO', 'UAA', 'KVUE', 'BORR', 'GTES', 'HUN', 'ACRE', 'CNH', 'PTEN', 'QXO', 'XIFR', 'HLMN', 'BAK']
