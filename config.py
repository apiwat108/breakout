...
BREAKOUT_SYMBOLS_5MX0_AB = ['BTCS', 'ABSI', 'GLXY', 'PBI', 'JMIA', 'CLF', 'PLUG', 'AVXL', 'BYND', 'UEC', 'ASPI', 'SNAP', 'ABAT', 'OPEN', 'LEVI', 'WT', 'BMBL', 'VNET', 'BYON', 'IE', 'ABR', 'U', 'CHGG', 'WBD', 'FFAI', 'IVZ', 'BLNE', 'QS', 'DNUT', 'UAVS', 'LAC', 'PDYN', 'HOUS', 'AAL', 'AMBC', 'KODK', 'KIRK', 'LAR', 'INVZ', 'EAF', 'GOSS', 'NEXT', 'XRX', 'AMPY', 'BITF', 'CDLX', 'SNDL', 'NB', 'STGW', 'RF', 'WOOF', 'REAL', 'METC', 'CIFR', 'SY', 'RCI', 'LWLG', 'GPRO', 'ASPN', 'HIVE', 'BTU', 'AMPX', 'UUUU', 'RGTI', 'VERI', 'IOVA', 'AMLX']