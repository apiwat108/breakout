...
BREAKOUT_SYMBOLS_5MX0_AB = ['ITOS', 'CDP', 'ADTN', 'ONON', 'MRC', 'LXRX', 'FHN', 'MRVI', 'GES', 'XERS', 'INO', 'ESRT', 'ALLO', 'CNNE', 'UNIT', 'AVDL', 'BZH', 'ASTH', 'FYBR', 'ERAS', 'DOCS', 'VLY', 'AUTL', 'PDCO', 'GH', 'NBBK', 'ASTL', 'EB', 'NBTB', 'VRRM', 'AEHR', 'BHVN', 'DOMO', 'IMXI', 'SOFI', 'CTKB', 'COMP', 'RDFN', 'EXLS', 'MCW', 'KNSA', 'IGR', 'CPB', 'NNN', 'WTTR', 'SLN', 'ACB', 'VICI', 'XLRE', 'GLPI', 'ATXS', 'BFH', 'WBD', 'GT', 'MATV', 'CMAX', 'CLBT', 'LC', 'ADPT', 'APEI', 'TELL', 'PPC', 'KIM', 'FDL', 'ARI']
