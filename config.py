...
BREAKOUT_SYMBOLS_5MX0_AB = ['GERN', 'HOPE', 'DC', 'DDL', 'BGS', 'ARTV', 'DBI', 'AHCO', 'WRBY', 'CTRI', 'VNDA', 'HLF', 'FNB', 'ABUS', 'AROC', 'WU', 'LION', 'CGC', 'CRON', 'RF', 'TWO', 'VLY', 'FOLD', 'CLYM', 'OCUL', 'NEOG', 'EYPT', 'LEG', 'COLB']
