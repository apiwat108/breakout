...
BREAKOUT_SYMBOLS_5MX0_AB = ['DAWN', 'AQN', 'BTE', 'OUT', 'SLDP', 'CX', 'AAL', 'URGN', 'NOV', 'GDYN', 'MD', 'CSIQ', 'EWTX', 'DRH', 'CERS', 'GPRK', 'TDC', 'KODK', 'THS', 'GGB', 'PUMP', 'DAN', 'VIAV', 'IRWD', 'LFST', 'SUPV', 'MODG', 'TEVA', 'SPRU', 'CDNA', 'FSLY', 'F', 'TXG', 'RIG', 'GCI']