...
BREAKOUT_SYMBOLS_5MX0_AB = ['SLNH', 'DK', 'NEXT', 'MLCO', 'TDOC', 'ABCL', 'ENVX', 'BLMN', 'BLCO', 'GAME', 'QTTB', 'WULF', 'AMPX', 'AEHR', 'SOUN', 'MUX', 'MARA', 'ADNT', 'SRI', 'QS', 'LEVI', 'HIVE', 'EVH', 'UMAC', 'AMLX', 'GTN', 'NAVI', 'HUT', 'PRME', 'VNET', 'RCI', 'BTCS', 'TXG', 'VIAV', 'WT', 'INVZ', 'CIFR', 'CAE', 'SY', 'JMIA', 'POET', 'BGC', 'ANNX', 'PACB', 'UAVS', 'IE', 'UUUU', 'BKSY', 'ACI', 'RMNI', 'SKYE', 'PGNY', 'U', 'FHB', 'SLI', 'ASPN', 'BMBL', 'ZVRA', 'LAR', 'AAL', 'SNAP', 'AMTX', 'GSAT', 'KAR', 'AGEN', 'JHX', 'PLUG']