...
BREAKOUT_SYMBOLS_5MX0_AB = ['ASB', 'RIGL', 'NPWR', 'FHB', 'AAOI', 'GRNT', 'CAE', 'WBD', 'CDXC', 'ACCO', 'KMT', 'AKBA', 'FFBC', 'GABC', 'FULT', 'BKR', 'QBTS', 'AMPX', 'ALT', 'IMAX', 'NBBK', 'AMTX', 'LIND', 'ASTE', 'AIOT', 'HFWA', 'CAN', 'MARA', 'HNST', 'HNRG', 'RELY', 'GTES', 'LZ', 'WWW', 'BLND', 'ANY', 'BTCT', 'BITF', 'CFLT', 'KOD', 'PINC', 'WSBC', 'SOUN', 'AEYE', 'GRND', 'LUMN', 'MDXG']
