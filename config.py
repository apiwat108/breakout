...
BREAKOUT_SYMBOLS_5MX0_AB = ['RXRX', 'FEMY', 'COMP', 'ADEA', 'U', 'BTSG', 'TMQ', 'MD', 'AUR', 'UDMY', 'ADPT', 'EH', 'QUBT', 'CRSR', 'EDIT', 'CAE', 'MATH', 'AIFF', 'TUYA', 'CPS', 'TME', 'TIGR', 'ARI', 'SABR', 'QD', 'RGTI', 'FULC', 'BEN', 'PBI', 'INZY', 'SJT', 'TSLX']