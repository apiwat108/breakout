...
BREAKOUT_SYMBOLS_5MX0_AB = ['TE', 'LWLG', 'RLAY', 'CDP', 'HR', 'XNET', 'MUX', 'BORR', 'BTSG', 'HUT', 'CDE', 'SONO', 'CC', 'GAU', 'HL', 'BTU', 'ONDS', 'TSHA', 'ROIV', 'NAD', 'EQX', 'AQST', 'ARWR', 'M', 'PL', 'NUVB', 'LDI', 'RUN', 'AGNC', 'AEO', 'MIR', 'OLMA', 'KGC']