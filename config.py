...
BREAKOUT_SYMBOLS_5MX0_AB = ['QUBT', 'GALT', 'ADNT', 'OSCR', 'CRK', 'ONL', 'CTOR', 'BRY', 'BKSY', 'DOMH', 'INVZ', 'GRRR', 'CCLD', 'EVH', 'EDIT', 'QTRX', 'TSSI', 'RELI', 'MIND', 'ALT', 'GTN', 'PACB', 'PBF', 'DNN', 'MANU', 'DGXX', 'CRML', 'ABCL', 'SA', 'CATX', 'WT', 'SKYE', 'AMTX', 'VERV', 'SY', 'ZETA', 'PHAT', 'BLMN', 'QXO', 'DNA', 'PLAY', 'OUST', 'PACS', 'GEOS', 'TDOC', 'DK', 'MOMO', 'TE']