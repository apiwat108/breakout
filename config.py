...
BREAKOUT_SYMBOLS_5MX0_AB = ['BTSG', 'M', 'CENX', 'JAMF', 'LION', 'AMPX', 'GRAB', 'BTU', 'DBRG', 'HL', 'EYE', 'MIR', 'SES', 'AEO', 'CLSK', 'AQST', 'QBTS', 'RGTI', 'BTE', 'ARWR', 'OCGN', 'EQX', 'RLAY', 'CDE', 'BLDP', 'TVTX', 'DNN', 'HUT', 'SONO', 'ROIV', 'APA', 'AG', 'LDI', 'FSLY', 'CDP', 'UPWK', 'RCAT', 'PAGS', 'WBD', 'PLUG', 'HIVE', 'BFLY', 'PL', 'NTLA', 'NXE', 'CC', 'KOPN', 'BTDR', 'MPW', 'REKR', 'RR', 'BLNE', 'BRY']