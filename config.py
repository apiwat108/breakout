...
BREAKOUT_SYMBOLS_5MX0_AB = ['DBRG', 'ABSI', 'RCKT', 'AVDL', 'BTDR', 'VERI', 'NVTS', 'PACB', 'AQST', 'CLF', 'LBRT', 'CCO', 'NNDM', 'RXRX', 'APLT', 'IRBT', 'RLAY', 'SAVA', 'F', 'SLDP', 'FLNC', 'INDI', 'QSI', 'SES', 'KOPN', 'LAES', 'ERIC', 'FATE', 'IE', 'TE', 'ACRS', 'SANA', 'NTLA', 'PATH', 'CAN']