...
BREAKOUT_SYMBOLS_5MX0_AB = ['CLOV', 'EBS', 'CSIQ', 'LBRT', 'IRWD', 'CABA', 'AXGN', 'ERIC', 'EWTX', 'NOK', 'PUMP', 'NOV', 'RIG', 'GDYN', 'PACB', 'DAN', 'GGB', 'VIAV', 'HAYW', 'SUPV', 'MNOV', 'GCI', 'GPRK', 'F', 'NMRA', 'AVDL', 'LEG', 'CX', 'ARQT', 'ACRS', 'MIR', 'AAL', 'DYN', 'LUMN', 'MD', 'IMVT']