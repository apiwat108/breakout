...
BREAKOUT_SYMBOLS_5MX0_AB = ['MDWD', 'CCL', 'EXAI', 'NYCB', 'XERS', 'AEHR', 'HOOD', 'TOST', 'EVGO', 'HEPS', 'ERAS', 'RXT', 'GLW', 'LC', 'NABL', 'GBTG', 'DOYU', 'ERJ', 'CDP', 'EOSE', 'LGVN', 'ESRT', 'JMIA', 'PLG', 'TAC', 'ASTH', 'ESI', 'AEHL', 'BFH', 'SLRN', 'CIM', 'INFN', 'CNK', 'HIMX', 'NWSA', 'NBTB', 'SYF', 'PBI', 'CUK', 'MNKD', 'IMXI', 'AGRO', 'VICI', 'EVRI', 'VRRM', 'ONON', 'BZH', 'BITF', 'CLBT', 'NVGS', 'MATV', 'NKTR', 'TVTX', 'NBBK', 'LAUR', 'CUBE', 'MRC', 'RLMD', 'JOBY', 'ENVX', 'EXLS', 'SLN', 'APEI', 'RVMD', 'AMH', 'PPC', 'LXRX', 'IREN', 'ADPT', 'ZG', 'MYO', 'SDIG', 'PLSE']
