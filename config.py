...
BREAKOUT_SYMBOLS_5MX0_AB = ['OCUL', 'FNB', 'TDC', 'KSS', 'COLB', 'ASTI', 'AROC', 'DC', 'BFLY', 'MIST', 'LION', 'DBI', 'RF', 'SWBI', 'AHCO', 'AMTM', 'BGS', 'ANNX', 'PTEN', 'WRBY', 'DXLG', 'PLBY', 'CPRI', 'BORR', 'AEO', 'VNDA', 'ADMA', 'CTRI', 'CGEM', 'IMMX', 'WU', 'HOPE', 'VLY', 'GERN', 'ESPR', 'HLF', 'LEG', 'CADL', 'EYPT', 'NEOG']
