...
BREAKOUT_SYMBOLS_5MX0_AB = ['MYO', 'NBTB', 'LGVN', 'CLBT', 'ENVX', 'PLSE', 'CUBE', 'HEPS', 'LXRX', 'LAUR', 'ZG', 'HIMX', 'CDP', 'TVTX', 'BZH', 'JMIA', 'AEHR', 'CIM', 'SLRN', 'MNKD', 'APEI', 'LC', 'VICI', 'BITF', 'XERS', 'PBI', 'SYF', 'RVMD', 'CUK', 'NYCB', 'VRRM', 'ESI', 'MRC', 'NKTR', 'TAC', 'JOBY', 'AAN', 'ADPT', 'ASTH', 'BFH', 'SDIG', 'NVGS', 'ESRT', 'EXLS', 'CCL', 'ERJ', 'ERAS', 'EVGO', 'NBBK', 'GLW']
