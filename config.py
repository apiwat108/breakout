...
BREAKOUT_SYMBOLS_5MX0_AB = ['PL', 'NPWR', 'BTU', 'APLT', 'PEPG', 'SERV', 'TMC', 'POET', 'RGTI', 'TE', 'CENX', 'SLI', 'BFLY', 'NFGC', 'ORIC', 'ZURA', 'SAVA', 'LAES', 'ABCL', 'LTBR', 'SES', 'NXL', 'LAC', 'TLRY', 'AQST', 'PATH', 'SLDP', 'FLNC', 'ANNX', 'QBTS', 'BANC', 'ARQT', 'IE', 'QUBT', 'ABAT', 'CLF', 'AMPX', 'LAR', 'FATE', 'NTLA', 'BTDR', 'QMCO', 'PLUG', 'INVZ', 'BLDP', 'SATL', 'CLSK', 'AG', 'CAN', 'OCGN', 'KOPN', 'RLAY']