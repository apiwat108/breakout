...
BREAKOUT_SYMBOLS_5MX0_AB = ['ABR', 'GOSS', 'AVXL', 'BITF', 'COUR', 'BTU', 'ASPN', 'STGW', 'ABAT', 'NEXT', 'PLUG', 'BYON', 'UAVS', 'JMIA', 'INVZ', 'EAF', 'UEC', 'PBI', 'UUUU', 'BMBL', 'GLXY', 'WT', 'IVZ', 'WBD', 'CLF', 'IOVA', 'RGTI', 'HOUS', 'XRX', 'DNUT', 'SCHL', 'METC', 'LAR', 'REAL', 'BLNE', 'FFAI', 'GPRO', 'ASPI', 'OPEN', 'LWLG', 'AMPX', 'WOOF', 'CHGG', 'SNDL', 'RF']