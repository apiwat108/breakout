...
BREAKOUT_SYMBOLS_5MX0_AB = ['APLT', 'INVZ', 'FATE', 'CLPT', 'SLDP', 'NRGV', 'BTDR', 'AMPX', 'ABCL', 'PEPG', 'PONY', 'ZURA', 'ANNX', 'TLRY', 'KOPN', 'BFLY', 'TMC', 'LAC', 'CLSK', 'ARWR', 'FLNC', 'PL', 'POET', 'ORIC', 'LAR', 'BLDP', 'AQST', 'QMCO', 'CAN', 'OCGN', 'BANC', 'ABAT', 'TE', 'SLI', 'BTU', 'LTBR', 'CENX', 'SAVA', 'NFGC', 'HAL', 'LAES', 'AG', 'ARQT', 'PLUG', 'NTLA', 'EYE', 'RLAY', 'QUBT', 'QBTS', 'SES', 'RGTI']