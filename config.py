...
BREAKOUT_SYMBOLS_5MX0_AB = ['BEPC', 'ORGO', 'VITL', 'SOFI', 'UNFI', 'SLI', 'TDOC', 'MTTR', 'GNLX', 'BW', 'LAC', 'TPR', 'UNG', 'MRSN', 'IRDM', 'BHC', 'INFA', 'SHOO', 'LAAC', 'MRNS', 'EAF', 'LEG', 'SGHC', 'RNAC', 'PRA', 'KGS', 'DESP', 'SID', 'ASM', 'ALKS', 'CMP', 'COLL', 'IONQ', 'RRGB', 'VERI', 'GTN']
