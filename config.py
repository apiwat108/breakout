...
BREAKOUT_SYMBOLS_5MX0_AB = ['CX', 'PUMP', 'ACRS', 'NOV', 'VIAV', 'EBS', 'AXGN', 'MNOV', 'GCI', 'NOK', 'LUMN', 'LEG', 'PACB', 'LBRT', 'GGB', 'CRNT', 'AVDL', 'F', 'SUPV', 'IRWD', 'NESR', 'GPRK', 'CSIQ', 'NMRA', 'CABA', 'HAYW', 'MIR', 'EWTX', 'RIG', 'CCO', 'AAL', 'IMVT', 'GDYN', 'ARQT', 'CLOV', 'DAN', 'DYN', 'ERIC']