...
BREAKOUT_SYMBOLS_5MX0_AB = ['ABUS', 'HOPE', 'HEPS', 'IVR', 'HLF', 'CGC', 'WU', 'CRON', 'WRBY', 'CLYM', 'VNDA', 'INFY', 'LUNR', 'DC', 'GERN', 'AROC', 'WIT', 'EYPT', 'DBI', 'RIVN', 'NEOG', 'TWO', 'FOLD', 'DDL', 'FNB', 'VLY', 'AHCO', 'LION', 'RF']
