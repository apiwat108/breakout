...
BREAKOUT_SYMBOLS_5MX0_AB = ['OLPX', 'SBLK', 'VLN', 'CRML', 'AEVA', 'AXL', 'VNET', 'ERAS', 'ARDX', 'ZNTL', 'IHS', 'EC', 'IPSC', 'ZETA', 'BAER', 'RKT', 'CDZI', 'UMC', 'CERS', 'DAWN', 'LIND', 'NEOG', 'CMPS', 'LUNR', 'PTEN', 'OSS', 'TWO', 'CMBT', 'OCGN', 'SID', 'IBRX']
