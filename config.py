...
BREAKOUT_SYMBOLS_5MX0_AB = ['QUBT', 'PHAT', 'TE', 'PLAY', 'ALT', 'PACB', 'GTN', 'MIND', 'EVH', 'MANU', 'AMTX', 'SY', 'COMM', 'DOMH', 'NU', 'GRRR', 'CCLD', 'BLMN', 'MOMO', 'PACS', 'ZETA', 'DNN', 'QXO', 'NKTR', 'TSSI', 'EXTR', 'CRML', 'CTOR', 'RCI', 'CATX', 'DGXX', 'OUST', 'AMLX', 'TDOC', 'BBAI', 'WT', 'ONL', 'ADNT', 'SKYE', 'BKSY', 'GALT', 'CRK', 'PBF', 'OSCR', 'GEOS', 'RELI', 'DNA', 'EDIT', 'BRY', 'NEXT', 'QTRX', 'RZLV', 'ABCL', 'VERV', 'INVZ']