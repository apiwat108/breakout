...
BREAKOUT_SYMBOLS_5MX0_AB = ['SLRN', 'BHVN', 'PLSE', 'ADPT', 'EVRI', 'WLY', 'ITOS', 'AVDL', 'CMAX', 'JMIA', 'BFH', 'IONS', 'AMH', 'ERAS', 'MATV', 'ONON', 'HOOD', 'BITF', 'NWSA', 'ASTH', 'GPRO', 'LAUR', 'MYO', 'TAC', 'APEI', 'NVGS', 'BZH', 'CDP', 'SLN', 'JBLU', 'JOBY', 'IMXI', 'VRRM', 'TELL', 'BBDC', 'JAMF', 'AEHR', 'DOMO', 'VICI', 'EOSE', 'AEHL', 'EVGO', 'LC', 'LRMR', 'RXT', 'MNKD', 'HIMX', 'HEPS', 'MDWD', 'NKTR', 'FUFU', 'PBI', 'JBGS', 'SDIG', 'FHN', 'GLW', 'CLBT', 'CCL', 'TOST', 'DOCS', 'LGVN', 'EXLS', 'CUBE', 'MRC', 'LXRX', 'NABL', 'ESRT', 'IREN', 'ATXS', 'ZG', 'CIM', 'EWTX', 'ERJ', 'ARIS', 'NYCB', 'CNK', 'NBTB', 'GBTG', 'NBBK', 'INFN', 'GRND', 'TVTX', 'XERS', 'GLBE', 'MREO', 'KNSA', 'RVMD', 'GH', 'ESI', 'SYF', 'PPC', 'ENVX', 'INO', 'CUK', 'DOYU', 'GLPI', 'EXAI', 'CNNE']
