...
BREAKOUT_SYMBOLS_5MX0_AB = ['KGC', 'GAU', 'MUX', 'RCAT', 'PL', 'LION', 'NUVB', 'TSHA', 'AQST', 'BTU', 'EQX', 'LDI', 'OLMA', 'ARWR', 'TVTX', 'DBRG', 'RLAY', 'AG', 'ROIV', 'CDP', 'WBD', 'M', 'SONO', 'BORR', 'JAMF', 'CC', 'HUT', 'HR', 'HL', 'BTSG', 'TE', 'MIR', 'AGNC', 'AEO', 'CDE']