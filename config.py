...
BREAKOUT_SYMBOLS_5MX0_AB = ['QTRX', 'ONL', 'PACB', 'BKSY', 'RCI', 'NU', 'MIND', 'CTOR', 'EYPT', 'POET', 'TSSI', 'JHX', 'AMLX', 'OUST', 'GEOS', 'JMIA', 'QS', 'ERO', 'BBAI', 'ADPT', 'HBM', 'PACS', 'CAE', 'SRI', 'VIAV', 'PLUG', 'CORZW', 'EVH', 'INVZ', 'CORZ', 'EB', 'VERV', 'AUPH', 'MANU', 'IE', 'OSCR', 'ZETA', 'DGXX', 'SERA', 'CRML', 'SY', 'ABCL', 'NKTR', 'NEXT', 'TWI', 'BGC', 'RZLV', 'GALT', 'DNA', 'VNET', 'WT', 'AEHR', 'COMM', 'EXTR', 'TDOC', 'ARBE', 'ENVX', 'GTN', 'MGNI', 'DOMH', 'MLCO', 'BMBL', 'EXFY', 'TXG', 'BLCO', 'AMTX', 'NAK', 'ADNT', 'DNN', 'SKYE']