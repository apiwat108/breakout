...
BREAKOUT_SYMBOLS_5MX0_AB = ['INVZ', 'IRBT', 'ASPI', 'FATE', 'SLDP', 'CLF', 'CLSK', 'DBRG', 'ABCL', 'JDZG', 'SES', 'NPWR', 'QBTS', 'QSI', 'LAC', 'SANA', 'SAVA', 'AQST', 'ABAT', 'PATH', 'INDI', 'ERIC', 'POET', 'SLI', 'NTLA', 'RGTI', 'LAES', 'BLDP', 'BZAI', 'CAN', 'BTDR', 'CATX', 'SERV', 'TMC', 'LODE', 'VERI', 'WTI', 'NNDM', 'IE', 'BTU', 'RLAY', 'LTBR', 'NFGC', 'ABSI', 'FLNC', 'GWH', 'LAR', 'ORLA', 'RCKT', 'PLUG', 'ARQT', 'RXRX', 'APLT', 'AG', 'KOPN', 'NVTS', 'ORIC', 'CENX', 'TE']