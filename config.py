...
BREAKOUT_SYMBOLS_5MX0_AB =  ['MCW', 'PPC', 'CNNE', 'AUTL', 'CTKB', 'CDP', 'ELME', 'CLBT', 'XLRE', 'ADTN', 'MIRA', 'KNSA', 'BHVN', 'FYBR', 'GLPI', 'VICI', 'PDCO', 'KIM', 'UNIT', 'WBD', 'VLY', 'NWN', 'BZH', 'NBTB', 'AVDL', 'ONON', 'ACB', 'MRVI', 'NBBK', 'CPB', 'RPRX', 'MATV', 'FDL', 'ASTH', 'GES', 'ASTL', 'IMXI', 'WTTR', 'XENE', 'ITOS', 'TELL', 'IGR', 'LC', 'GH', 'CMAX', 'ADPT']
