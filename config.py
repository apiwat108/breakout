...
BREAKOUT_SYMBOLS_5MX0_AB = ['OSS', 'AXL', 'TWO', 'CGTL', 'AEVA', 'ZETA', 'FBIO', 'DAWN', 'RKT', 'ERAS', 'ARDX', 'VLN', 'FLYX', 'SID', 'IBRX', 'OCGN', 'DDL', 'FHB', 'SBLK', 'PTEN', 'CMPS', 'VNET', 'OLPX', 'CRML', 'ZNTL', 'LUNR', 'NEOG', 'CMBT', 'IPSC', 'LIND', 'UMC', 'EC', 'BAER']
