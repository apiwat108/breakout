...
BREAKOUT_SYMBOLS_5MX0_AB = ['ABAT', 'NB', 'HOUS', 'WBD', 'RCI', 'CLF', 'HIVE', 'INVZ', 'BLNE', 'BTU', 'SY', 'U', 'MARA', 'GRRRW', 'AMPX', 'LEVI', 'JMIA', 'IE', 'METC', 'VNET', 'AMPY', 'BTCS', 'VERI', 'CHGG', 'KODK', 'STGW', 'PLUG', 'UEC', 'NEXT', 'GPRO', 'RF', 'UUUU', 'RGTI', 'AAL', 'SNAP', 'ABR', 'UMAC', 'DNUT', 'PRME', 'BEEM', 'OPEN', 'MLCO', 'KIRK', 'EAF', 'UAVS', 'AMBC', 'WOOF', 'QS', 'ABSI', 'LWLG', 'SNDL', 'BYON', 'WULF', 'LAC', 'PDYN', 'PBI', 'REAL', 'BYND', 'AMLX', 'GOSS', 'CDLX', 'CIFR', 'LAR', 'SLI', 'ASPI', 'BMBL', 'GLXY', 'BITF', 'ENVX', 'WT', 'ASPN', 'FFAI', 'IVZ']