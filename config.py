...
BREAKOUT_SYMBOLS_5MX0_AB = ['CLSK', 'NTLA', 'ARWR', 'NRGV', 'SES', 'PONY', 'AQMS', 'DNN', 'AG', 'TE', 'SAVA', 'RR', 'BRY', 'WBD', 'QBTS', 'LAC', 'BTU', 'APLT', 'BLDP', 'NXE', 'LTBR', 'FSLY', 'AMPX', 'BLNE', 'PL', 'CENX', 'ANNX', 'HAL', 'ABAT', 'BTE', 'LRMR', 'UPWK', 'WRD', 'SLI', 'BTDR', 'CDE', 'QUBT', 'RLAY', 'BFLY', 'CLPT', 'OCGN', 'FLNC', 'EYE', 'JAMF', 'GRAB', 'AQST', 'PEPG', 'REKR', 'ROIV', 'RGTI', 'QMCO', 'PLUG', 'NFGC']