...
BREAKOUT_SYMBOLS_5MX0_AB = ['PACS', 'PACB', 'AMTX', 'MOMO', 'PHUN', 'ABCL', 'MANU', 'SA', 'CRK', 'QTRX', 'BLMN', 'DNN', 'CRML', 'ADNT', 'QUBT', 'BRY', 'VERV', 'ALT', 'OUST', 'EDIT', 'PHAT', 'RELI', 'TSSI', 'DGXX', 'MVST', 'PLAY', 'FCEL', 'CHGG', 'APPS', 'DNA', 'WT', 'UROY', 'TE', 'PBF', 'TGB', 'BTE', 'GALT', 'DK']