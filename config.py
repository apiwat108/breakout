...
BREAKOUT_SYMBOLS_5MX0_AB = ['RF', 'ABUS', 'FOLD', 'EYPT', 'CTRI', 'AHCO', 'OCUL', 'NEOG', 'HOPE', 'FNB', 'ARTV', 'VLY', 'CRON', 'LEG', 'BGS', 'IMMX', 'HLF', 'ASTI', 'WRBY', 'DC', 'LION', 'GERN', 'COLB', 'WU', 'CGC', 'CLYM', 'AROC', 'DBI', 'VNDA']
