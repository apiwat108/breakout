...
BREAKOUT_SYMBOLS_5MX0_AB =  ['PBI', 'MATV', 'ERJ', 'AGEN', 'HEPS', 'NKTR', 'NWSA', 'CUK', 'ZG', 'JOBY', 'NABL', 'MNKD', 'AGRO', 'CCL', 'TVTX', 'HIMX', 'GBTG', 'NBTB', 'ENVX', 'ESI', 'CDP', 'SDIG', 'LC', 'IREN', 'ASTH', 'CLBT', 'GLW', 'JMIA', 'EVRI', 'LXRX', 'ESRT', 'ADPT', 'LGVN', 'CUBE', 'VICI', 'TOST', 'MYO', 'INFN', 'SLRN', 'APEI', 'NVGS', 'TAC', 'EVGO', 'VTEX', 'RVMD', 'EXLS', 'HOOD', 'LAUR', 'VRRM', 'MRC', 'NBBK', 'NYCB', 'IMXI', 'BFH', 'BITF', 'ERAS', 'NIU', 'CIM', 'PPC', 'EXAI', 'SYF', 'XERS', 'AEHR', 'PLSE', 'BZH']
