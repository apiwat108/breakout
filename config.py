...
BREAKOUT_SYMBOLS_5MX0_AB = ['PUMP', 'LFST', 'VIAV', 'TDC', 'F', 'NOK', 'GPRK', 'SUPV', 'GDYN', 'HAYW', 'RIG', 'IRWD', 'ARQT', 'DAN', 'LBRT', 'AAL', 'GGB', 'AXGN', 'SLDP', 'AVDL', 'TEVA', 'MIR', 'CX', 'MD', 'NOV', 'VTRS', 'IMVT', 'DAWN', 'CDNA', 'EWTX', 'NMRA', 'URGN', 'GCI', 'CSIQ', 'FSLY', 'LUMN']