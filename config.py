...
BREAKOUT_SYMBOLS_5MX0_AB = ['LXRX', 'HOOD', 'AGEN', 'CDP', 'EOSE', 'ONON', 'VICI', 'SYF', 'JOBY', 'LC', 'JMIA', 'MATV', 'HEPS', 'CUK', 'NKTR', 'MYO', 'MRC', 'TVTX', 'BITF', 'TOST', 'BZH', 'NABL', 'ASTH', 'BFH', 'CLBT', 'AEHR', 'ENVX', 'ERJ', 'EXLS', 'LGVN', 'EXAI', 'EVGO', 'CCL', 'INFN', 'SLRN', 'NBBK', 'AGRO', 'CIM', 'NYCB', 'GBTG', 'SDIG', 'NVGS', 'VRRM', 'CNK', 'NBTB', 'IREN', 'APEI', 'ESI', 'GLW', 'TAC', 'XERS', 'MNKD', 'HIMX', 'RVMD', 'NIU', 'NWSA', 'ZG', 'EVRI', 'ADPT', 'VTEX', 'ERAS', 'PLSE', 'ESRT', 'PPC', 'IMXI', 'LAUR', 'CUBE', 'PBI']
