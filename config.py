...
BREAKOUT_SYMBOLS_5MX0_AB = ['LTBR', 'BTE', 'EYE', 'CC', 'BLNE', 'PAGS', 'CDP', 'HL', 'QBTS', 'SES', 'TVTX', 'AG', 'OCGN', 'AEO', 'MPW', 'NRGV', 'LION', 'QMCO', 'KOPN', 'HIVE', 'JAMF', 'LDI', 'BTSG', 'ARWR', 'PLUG', 'DBRG', 'RR', 'CENX', 'AQST', 'GRAB', 'UPWK', 'BLDP', 'BTU', 'DNN', 'BRY', 'MIR', 'RGTI', 'BFLY', 'M', 'ROIV', 'NTLA', 'NXE', 'RLAY', 'REKR', 'CDE', 'HUT', 'PONY', 'RCAT', 'EQX', 'BTDR', 'WBD', 'PL', 'FSLY', 'SERV', 'QUBT', 'WRD', 'CLSK', 'AMPX']