...
BREAKOUT_SYMBOLS_5MX0_AB = ['ZG', 'ERAS', 'SDIG', 'APEI', 'BFH', 'CLBT', 'TVTX', 'ESRT', 'EVRI', 'BITF', 'HEPS', 'SYF', 'ENVX', 'HIMX', 'IREN', 'ADPT', 'EXLS', 'PLSE', 'LC', 'NVGS', 'LGVN', 'ASTH', 'CIM', 'CCL', 'MRC', 'INFN', 'CUBE', 'RVMD', 'TAC', 'PBI', 'AAN', 'GLW', 'VRRM', 'LAUR', 'LXRX', 'NYCB', 'NBBK', 'NBTB', 'MYO', 'ESI', 'XERS', 'MNKD', 'VICI', 'CUK', 'EVGO', 'JOBY', 'SLRN', 'CDP', 'NKTR', 'JMIA', 'AEHR', 'BZH', 'ERJ']
