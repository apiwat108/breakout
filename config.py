...
BREAKOUT_SYMBOLS_5MX0_AB = ['WT', 'OUST', 'QUBT', 'TME', 'MANU', 'TGB', 'ABCL', 'EDIT', 'CRSR', 'DOMO', 'ADNT', 'PLAY', 'TSSI', 'QTRX', 'DGXX', 'PHUN', 'PBI', 'AMTX', 'TUYA', 'GRRR', 'UDMY', 'BTE', 'PHAT', 'HUT', 'SA', 'FATE', 'MOMO', 'MATH', 'ZVRA', 'FCEL', 'CHGG', 'ALT']