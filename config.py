...
BREAKOUT_SYMBOLS_5MX0_AB = ['WU', 'IMMX', 'MNRO', 'BORR', 'GERN', 'NEOG', 'RF', 'FNB', 'AROC', 'BGS', 'HOPE', 'ESPR', 'DBI', 'AHCO', 'DC', 'AMTM', 'CTRI', 'ASTI', 'HLF', 'CADL', 'CRON', 'VLY', 'PTEN', 'WRBY', 'EYPT', 'OGI', 'LEG', 'CGC', 'OCUL', 'CLYM', 'COLB', 'LION', 'VNDA']
