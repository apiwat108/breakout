...
BREAKOUT_SYMBOLS_5MX0_AB =  ['ERAS', 'AEHR', 'PBI', 'TGI', 'SNAP', 'LGVN', 'EVCM', 'HEPS', 'MYO', 'SLRN', 'ESRT', 'NBBK', 'AAN', 'ESI', 'TVTX', 'LAUR', 'VRRM', 'QURE', 'CDP', 'MRC', 'APEI', 'JOBY', 'NYCB', 'LC', 'JMIA', 'ERJ', 'EXLS', 'GLW', 'NKTR', 'HTGC', 'HIMX', 'ADPT', 'CCL', 'NBTB', 'BTSG', 'IMAX', 'SYF', 'VFS', 'PEGY', 'CIM', 'CUK', 'BFH', 'RVMD', 'AAT', 'EVGO', 'ENVX', 'PACK', 'BTBT', 'MNKD', 'PLSE']
