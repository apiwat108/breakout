...
BREAKOUT_SYMBOLS_5MX0_AB = ['ATEN', 'KVUE', 'GTES', 'KRG', 'RIG', 'AES', 'BORR', 'QXO', 'CNH', 'FULT', 'FSLY', 'NVST', 'SFL', 'WULF', 'RIME', 'BGS', 'NMRA', 'KOS', 'SBLK', 'KPTI', 'CC', 'RWT', 'UAA', 'XIFR', 'PCG', 'LGO', 'AM', 'ATOM', 'SUZ', 'NTST', 'VNET', 'MITK', 'KMI']
