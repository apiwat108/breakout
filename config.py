...
BREAKOUT_SYMBOLS_5MX0_AB =   ['NKTR', 'SHCR', 'TFC', 'EXLS', 'LZB', 'ENVX', 'NBBK', 'ESI', 'BTBT', 'JOBY', 'GRND', 'TVTX', 'ERAS', 'PSTX', 'FPI', 'DYN', 'CIM', 'CUK', 'NSA', 'CLBT', 'VRRM', 'REPL', 'VFS', 'SILK', 'APEI', 'EVGO', 'SNAP', 'CCL', 'ARWR', 'EVCM', 'ADT', 'HEPS', 'NRIX', 'ZIMV', 'ARMK', 'MRC', 'IMAX', 'ATEX', 'GOVX', 'CMTL', 'CNK', 'ADCT', 'LAUR', 'ONL', 'BTSG', 'FIBK', 'PBI', 'AUPH', 'HIMX', 'RXO', 'PACK', 'CDP', 'ZETA', 'OCUL', 'TGS', 'RNA', 'ZUO', 'SLRN', 'MARA', 'NCNO', 'AAN', 'XPRO', 'KSS', 'URGN', 'HTGC', 'AAT', 'MTTR', 'BFH', 'NBTB', 'ESRT', 'BARK', 'NYCB', 'LC', 'SYF', 'FIGS', 'MNKD', 'TGI', 'CMRE', 'ADPT', 'UE']
