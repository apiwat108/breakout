...
BREAKOUT_SYMBOLS_5MX0_AB = ['SBLK', 'OLPX', 'IPSC', 'AXL', 'SID', 'BAER', 'FBIO', 'UMC', 'TWO', 'FLYX', 'FHB', 'ZETA', 'CGTL', 'CMPS', 'AEVA', 'DDL', 'EC', 'LUNR', 'PTEN', 'CMBT', 'RKT', 'NEOG', 'ERAS', 'VNET', 'CRML', 'ZNTL', 'ARDX', 'VLN']
