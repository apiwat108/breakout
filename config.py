...
BREAKOUT_SYMBOLS_5MX0_AB = ['WULF', 'IAG', 'SLDB', 'IMVT', 'LEVI', 'DT', 'ASPN', 'ORLA', 'EQX', 'RCUS', 'U', 'PPTA', 'BTBT', 'IOVA', 'FF', 'LUNR', 'BSAC', 'LWAY', 'FUBO', 'AKRO', 'SBH', 'POET', 'DOCN', 'FNKO', 'CGAU', 'MUX', 'GSAT', 'FLNC', 'RBRK', 'OLPX', 'ALDX', 'ITUB']
