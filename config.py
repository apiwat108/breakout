...
BREAKOUT_SYMBOLS_5MX0_AB = ['ARQT', 'TEVA', 'IRWD', 'NMRA', 'CSIQ', 'GDYN', 'PUMP', 'URGN', 'AAL', 'NOV', 'HAYW', 'SLDP', 'OUT', 'DAWN', 'SUPV', 'TXG', 'LFST', 'KODK', 'GCI', 'DAN', 'GGB', 'LUMN', 'MIR', 'CERS', 'MD', 'F', 'CDNA', 'AVDL', 'IMVT', 'TDC', 'AXGN', 'VIAV', 'RIG', 'MODG', 'CX', 'GPRK', 'AQN', 'EWTX', 'FSLY']