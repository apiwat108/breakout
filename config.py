...
BREAKOUT_SYMBOLS_5MX0_AB = ['PL', 'NFGC', 'PONY', 'AQMS', 'QBTS', 'AMPX', 'SLI', 'CDE', 'NXE', 'LTBR', 'BRY', 'DNN', 'RGTI', 'OCGN', 'WBD', 'BTU', 'CLSK', 'BLDP', 'CLPT', 'ABAT', 'BLNE', 'QUBT', 'FLNC', 'HAL', 'FSLY', 'SES', 'BFLY', 'PEPG', 'GRAB', 'EYE', 'ROIV', 'TLRY', 'QMCO', 'TE', 'ANNX', 'BTDR', 'AQST', 'ARQT', 'UPWK', 'RLAY', 'CENX', 'APLT', 'NTLA', 'AG', 'ARWR', 'LAC', 'REKR', 'NRGV', 'PLUG', 'SAVA']