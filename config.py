...
BREAKOUT_SYMBOLS_5MX0_AB = ['NMRA', 'ARQT', 'KODK', 'AAL', 'EWTX', 'SLDP', 'LFST', 'CX', 'GPRK', 'NOV', 'GDYN', 'GCI', 'VIAV', 'FSLY', 'AQN', 'F', 'OUT', 'IRWD', 'URGN', 'GGB', 'CDNA', 'DRH', 'TXG', 'MODG', 'RIG', 'TDC', 'SUPV', 'CSIQ', 'TEVA', 'CERS', 'DAWN', 'IMVT', 'DAN', 'MD', 'PUMP', 'LUMN', 'THS']