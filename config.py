...
BREAKOUT_SYMBOLS_5MX0_AB = ['APLT', 'LAES', 'BLDP', 'ORIC', 'RGTI', 'ABSI', 'PLUG', 'FLNC', 'CATX', 'IE', 'DBRG', 'CAN', 'RCKT', 'AQST', 'POET', 'TE', 'RXRX', 'LTBR', 'ERIC', 'VERI', 'SLDP', 'NTLA', 'INVZ', 'BTDR', 'FATE', 'GWH', 'ASPI', 'ABCL', 'SANA', 'QSI', 'CENX', 'NFGC', 'SES', 'SERV', 'KOPN', 'RLAY', 'LODE', 'IRBT', 'TMC', 'BTU', 'PATH', 'WTI', 'SAVA', 'AG', 'CLSK', 'CLF', 'SLI', 'INDI', 'NVTS', 'NPWR', 'BZAI', 'ARQT', 'ORLA', 'NNDM', 'QBTS']