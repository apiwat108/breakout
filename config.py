...
BREAKOUT_SYMBOLS_5MX0_AB = ['ENVX', 'EXLS', 'NYCB', 'JMIA', 'PLSE', 'VICI', 'JOBY', 'BFH', 'AEHR', 'CIM', 'BZH', 'SLRN', 'NBBK', 'EVGO', 'NKTR', 'ESI', 'LGVN', 'TVTX', 'TAC', 'ESRT', 'DTC', 'LC', 'CCL', 'HEPS', 'SYF', 'MYO', 'NBTB', 'ERAS', 'VRRM', 'APEI', 'HIMX', 'RVMD', 'AAN', 'ERJ', 'CDP', 'MNKD', 'XERS', 'ASTH', 'LXRX', 'PBI', 'CUK', 'LAUR', 'ZG', 'ADPT', 'GLW', 'MRC', 'QURE', 'SNAP', 'PEGY']
