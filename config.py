...
BREAKOUT_SYMBOLS_5MX0_AB = ['BTDR', 'PONY', 'TE', 'AG', 'ORIC', 'SAVA', 'LAES', 'FATE', 'BLDP', 'TLRY', 'NTLA', 'PL', 'INVZ', 'EYE', 'FLNC', 'SLDP', 'SES', 'CLSK', 'ARWR', 'ARQT', 'LTBR', 'CAN', 'QBTS', 'CLPT', 'APLT', 'ZURA', 'NRGV', 'KOPN', 'HAL', 'AMPX', 'LAC', 'BANC', 'CENX', 'OCGN', 'ABCL', 'BFLY', 'AQST', 'SLI', 'QUBT', 'RGTI', 'ANNX', 'QMCO', 'ABAT', 'PEPG', 'PLUG', 'NFGC', 'RLAY', 'BTU']