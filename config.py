...
BREAKOUT_SYMBOLS_5MX0_AB = ['VERI', 'UMC', 'UTZ', 'UGP', 'SKYT', 'ELAN', 'FOLD', 'SUPV', 'STNE', 'VSCO', 'SU', 'VCYT', 'HAYW', 'VMEO', 'AMH', 'XP', 'DAR', 'ENB', 'CLNE', 'PAY', 'GGAL', 'CSTL', 'AGRO', 'SG', 'VTEX', 'CNQ', 'PAYO', 'BBAR', 'DOMO', 'ABEV', 'STKL', 'SHIP']
