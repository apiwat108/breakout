...
BREAKOUT_SYMBOLS_5MX0_AB = ['DBRG', 'BTU', 'HL', 'PL', 'HIVE', 'BFLY', 'WBD', 'SERV', 'ROIV', 'SES', 'FSLY', 'EYE', 'CDP', 'EQX', 'QMCO', 'NTLA', 'BRY', 'UPWK', 'MIR', 'PONY', 'MPW', 'JAMF', 'BLNE', 'QBTS', 'PAGS', 'OCGN', 'AMPX', 'AQST', 'HUT', 'RCAT', 'WRD', 'ARWR', 'BTSG', 'AG', 'BTDR', 'LION', 'REKR', 'PLUG', 'BLDP', 'KOPN', 'RGTI', 'CC', 'LTBR', 'GRAB', 'CENX', 'TVTX', 'NXE', 'BTE', 'NRGV', 'CDE', 'RLAY', 'CLSK', 'DNN', 'RR', 'QUBT']