...
BREAKOUT_SYMBOLS_5MX0_AB = ['BZH', 'NBBK', 'MREO', 'TELL', 'FHN', 'GLPI', 'VICI', 'FDL', 'VLY', 'PDCO', 'ASTL', 'NYCB', 'MRVI', 'ADTN', 'CMAX', 'ACB', 'VTS', 'IONS', 'ADPT', 'XERS', 'COMP', 'KYMR', 'MATV', 'CHX', 'GH', 'ONON', 'CTKB', 'AUTL', 'SLN', 'MTCH', 'BLND', 'APA', 'ERAS', 'ATXS', 'PHIN', 'RVMD', 'APEI', 'ESRT', 'IMXI', 'BHVN', 'GT', 'SNDX', 'CPB', 'KNSA', 'SOFI', 'NKTR', 'JAMF', 'ALLO', 'MYO', 'GES', 'DOCS', 'PPBI', 'CDP', 'RDFN', 'MRC', 'BFH', 'PPC', 'VRRM', 'NBTB', 'DEC', 'GPRO', 'KIM', 'WTTR', 'LC', 'LXRX', 'UNIT', 'EB', 'CLBT', 'DOMO', 'RUM', 'IGR', 'XLRE', 'CNNE', 'SLRN', 'AEHR', 'AVDL', 'WBD', 'ASTH', 'EXLS', 'ITOS', 'ERJ', 'INO', 'VYX', 'FYBR', 'OPEN', 'MCW']
