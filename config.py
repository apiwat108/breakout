...
BREAKOUT_SYMBOLS_5MX0_AB = ['PACS', 'CRML', 'MVST', 'MANU', 'APPS', 'WT', 'TE', 'VERV', 'ABCL', 'UROY', 'PHAT', 'DNA', 'DNN', 'GALT', 'ADNT', 'TGB', 'BLMN', 'PLAY', 'PACB', 'CRK', 'QTRX', 'EDIT', 'RELI', 'OUST', 'TSSI', 'DK', 'QUBT', 'AMTX', 'PBF', 'DGXX', 'BTE', 'ALT', 'MOMO', 'BRY', 'SA']