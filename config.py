...
BREAKOUT_SYMBOLS_5MX0_AB = ['LUNR', 'CMBT', 'LODE', 'IBRX', 'EC', 'DAWN', 'PTEN', 'NEOG', 'TYGO', 'FULT', 'EGY', 'UMC', 'OSS', 'DNLI', 'ERAS', 'KMI', 'CRML', 'MAIA', 'CRVS', 'GLDD', 'CDZI', 'BAER', 'CERS', 'CMPS', 'VLN', 'ARDX', 'AXL', 'AEVA', 'SBLK', 'ACRS', 'TWO', 'IPSC', 'ZNTL', 'EGBN']
