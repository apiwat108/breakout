...
BREAKOUT_SYMBOLS_5MX0_AB = ['VLN', 'CRVS', 'ZNTL', 'CMPS', 'IPSC', 'EC', 'LUNR', 'SBLK', 'OCGN', 'OLPX', 'UMC', 'MAIA', 'DAWN', 'CDZI', 'EGY', 'OSS', 'CMBT', 'ERAS', 'PTEN', 'CERS', 'RKT', 'BAER', 'TWO', 'GLDD', 'AEVA', 'CRML', 'NEOG', 'ACRS', 'IBRX', 'AXL', 'TYGO', 'ARDX']
