...
BREAKOUT_SYMBOLS_5MX0_AB = ['CFLT', 'CDXC', 'LZ', 'AMPX', 'DESP', 'GABC', 'CTRI', 'BKR', 'HFWA', 'AMTX', 'HNRG', 'RELY', 'WBD', 'BITF', 'WWW', 'SOUN', 'KMT', 'ET', 'KOD', 'FULT', 'LUMN', 'RIGL', 'FFBC', 'FHB', 'HNST', 'GTES', 'LIND', 'ARIS', 'ASTE', 'SLM', 'AEYE', 'AAOI', 'ALT', 'BTCT', 'ASB', 'QBTS', 'WSBC', 'NBBK', 'MDXG', 'PINC', 'CAN', 'ATAI', 'RCAT', 'ACCO', 'NPWR', 'BLND', 'CAE', 'GRNT', 'ANY', 'AIOT', 'SEI', 'IMAX', 'VTRS', 'MARA']
