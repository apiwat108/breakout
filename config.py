...
BREAKOUT_SYMBOLS_5MX0_AB = ['NKTR', 'VNET', 'VERV', 'POET', 'SERA', 'GEOS', 'PLUG', 'MIND', 'BLMN', 'IE', 'ONL', 'SY', 'GTN', 'MGNI', 'CORZ', 'ABCL', 'BMBL', 'WT', 'NAK', 'HBM', 'QTRX', 'EB', 'CRML', 'ENVX', 'EXFY', 'ZETA', 'BGC', 'AMLX', 'MUX', 'EVH', 'NU', 'GALT', 'PACB', 'JMIA', 'NEXT', 'OPRA', 'JHX', 'SNAP', 'COMM', 'QS', 'SKYE', 'EXTR', 'OSCR', 'CTOR', 'INVZ', 'BKSY', 'BBAI', 'CAE', 'ADNT', 'ARBE', 'TSSI', 'DNA', 'AMTX', 'TXG', 'OUST', 'AEHR', 'ERO', 'PACS', 'VIAV', 'TWI', 'RZLV', 'TDOC', 'BUSE', 'RCI', 'BLCO', 'SRI', 'CORZW', 'MLCO', 'ADPT']