...
BREAKOUT_SYMBOLS_5MX0_AB = ['PACB', 'SKYE', 'SY', 'AUPH', 'MLCO', 'MANU', 'CCLD', 'HBM', 'CORZW', 'BLMN', 'BKSY', 'DNN', 'GEOS', 'NKTR', 'RCI', 'NEXT', 'BMBL', 'RELI', 'JHX', 'INVZ', 'NU', 'EVH', 'PACS', 'AEHR', 'ABCL', 'TXG', 'CTOR', 'ARBE', 'ONL', 'EXTR', 'OSCR', 'NAK', 'MIND', 'DGXX', 'ERO', 'RZLV', 'ENVX', 'EXFY', 'VIAV', 'VERV', 'QS', 'GRRR', 'IE', 'QTRX', 'TWI', 'POET', 'GALT', 'BGC', 'CATX', 'ADNT', 'AMTX', 'AMLX', 'VNET', 'EYPT', 'ZETA', 'MOMO', 'CORZ', 'BBAI', 'CRK', 'EB', 'DOMH', 'SERA', 'ADPT', 'TSSI', 'SRI', 'WT', 'CRML', 'OUST', 'TDOC', 'GTN', 'DNA', 'COMM']