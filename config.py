...
BREAKOUT_SYMBOLS_5MX0_AB = ['AQST', 'ABCL', 'CAN', 'APLT', 'NFGC', 'ABAT', 'SAVA', 'PL', 'ARWR', 'BTU', 'PLUG', 'AMPX', 'EYE', 'SLI', 'LTBR', 'FLNC', 'QBTS', 'BTDR', 'ANNX', 'PONY', 'FATE', 'CLSK', 'TE', 'PEPG', 'LAC', 'INVZ', 'BLDP', 'TLRY', 'RLAY', 'SES', 'NTLA', 'RGTI', 'AG', 'BFLY', 'CENX', 'ARQT', 'QMCO', 'OCGN', 'ZURA', 'QUBT', 'NRGV', 'HAL', 'CLPT']