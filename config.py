...
BREAKOUT_SYMBOLS_5MX0_AB = ['PDYN', 'GLXY', 'SCHL', 'UAVS', 'FFAI', 'LWLG', 'AMLX', 'CHGG', 'AMPX', 'SNDL', 'BMBL', 'HIVE', 'JMIA', 'HOUS', 'CLF', 'U', 'GOSS', 'LAR', 'ABAT', 'REAL', 'STGW', 'METC', 'SNAP', 'ASPN', 'WOOF', 'IVZ', 'RGTI', 'CDLX', 'NEXT', 'WBD', 'UEC', 'BTU', 'PLUG', 'BITF', 'AMBC', 'LAC', 'RF', 'KODK', 'WT', 'EAF', 'PBI', 'COUR', 'BYON', 'INVZ', 'QS', 'BLNE', 'UUUU', 'VERI', 'ASPI', 'BYND', 'AVXL', 'DNUT', 'ABR', 'OPEN', 'GPRO', 'IOVA', 'XRX']