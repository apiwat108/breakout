...
BREAKOUT_SYMBOLS_5MX0_AB = ['ANNX', 'BGS', 'FFBC', 'AHCO', 'WRBY', 'SWBI', 'ASTI', 'LEG', 'BUSE', 'TDC', 'ADMA', 'ESPR', 'BORR', 'KSS', 'DBI', 'RF', 'DC', 'IMMX', 'AEO', 'EYPT', 'OCUL', 'HOPE', 'HLF', 'WU', 'OII', 'AMTM', 'PLBY', 'PTEN', 'AROC', 'COLB', 'FNB', 'CPRI', 'CTRI', 'VLY', 'CGEM', 'BFLY', 'VNDA']
