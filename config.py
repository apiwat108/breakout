...
BREAKOUT_SYMBOLS_5MX0_AB = ['AMPX', 'UCB', 'ZVIA', 'FULT', 'BKU', 'GEO', 'HOMB', 'KOD', 'MARA', 'ALT', 'PINC', 'KAR', 'FHN', 'QBTS', 'RELY', 'ASB', 'IMAX', 'RF', 'NBBK', 'WBD', 'UAA', 'CFG', 'FHB', 'ASTE', 'SGHC', 'GTES', 'HBAN', 'HNRG', 'RIGL', 'ANY', 'WSBC', 'WRBY', 'NPWR', 'BLND', 'CAE', 'LUMN', 'FFBC', 'BITF', 'CDXC', 'BTCT', 'BKR', 'AIOT', 'AAOI', 'WWW', 'RCAT', 'AEYE', 'AMTX', 'KLTR', 'DESP', 'ARIS', 'SLM', 'ATAI', 'VTRS', 'GABC', 'TFC', 'SEI', 'SOUN', 'GRNT', 'HFWA', 'MDXG', 'FLYW', 'ACCO', 'CTRI', 'ET', 'CFLT', 'HNST', 'LIND', 'CAN', 'KMT']
