...
BREAKOUT_SYMBOLS_5MX0_AB =  ['ADPT', 'ZG', 'SDIG', 'ASTH', 'CUK', 'BFH', 'HEPS', 'NKTR', 'LGVN', 'RVMD', 'CDP', 'IMXI', 'EVRI', 'AGEN', 'TVTX', 'CIM', 'NBTB', 'MNKD', 'HIMX', 'ERAS', 'SLRN', 'VICI', 'EXLS', 'LC', 'SYF', 'NWSA', 'ESRT', 'MYO', 'LXRX', 'JOBY', 'APEI', 'TAC', 'PPC', 'LAUR', 'NVGS', 'ESI', 'GBTG', 'HOOD', 'MRC', 'NBBK', 'BZH', 'ENVX', 'CLBT', 'VTEX', 'NABL', 'NYCB', 'GLW', 'XERS', 'AEHR', 'BITF', 'CUBE', 'CCL', 'VRRM', 'EVGO', 'JMIA', 'IREN', 'PLSE', 'INFN', 'PBI', 'MATV', 'TOST', 'ERJ']
