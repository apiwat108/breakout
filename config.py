...
BREAKOUT_SYMBOLS_5MX0_AB = ['SLDP', 'ABSI', 'ORLA', 'RXRX', 'ERIC', 'VERI', 'TE', 'RCKT', 'PATH', 'NVTS', 'NTLA', 'INDI', 'IRBT', 'CAN', 'SANA', 'CLF', 'NNDM', 'BTDR', 'KOPN', 'AQST', 'CENX', 'AG', 'SES', 'GWH', 'FATE', 'FLNC', 'PACB', 'LBRT', 'RLAY', 'SAVA', 'APLT', 'LTBR', 'LAES', 'IE', 'CLSK', 'QSI', 'CCO', 'DBRG']