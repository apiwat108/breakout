...
BREAKOUT_SYMBOLS_5MX0_AB = ['VITL', 'INFA', 'SLI', 'GNW', 'WW', 'CART', 'PTCT', 'HOOD', 'TWG', 'RNAC', 'LAAC', 'GRND', 'BHC', 'EWTX', 'KTOS', 'BW', 'REAL', 'MDU', 'CPNG', 'LAC', 'MTTR', 'CNVS', 'DESP', 'VERI', 'KGS', 'IONQ', 'MIR', 'SOFI']
