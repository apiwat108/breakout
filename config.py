...
BREAKOUT_SYMBOLS_5MX0_AB = ['ADTN', 'KNSA', 'SLRN', 'JOBY', 'DOCS', 'GH', 'JAMF', 'MRVI', 'GBTG', 'ASTH', 'APEI', 'EVGO', 'BZH', 'DOMO', 'NYCB', 'KN', 'CMAX', 'AEHR', 'FYBR', 'LRMR', 'MNKD', 'ONON', 'IMXI', 'CIM', 'LAUR', 'CNNE', 'VTS', 'CPB', 'VRRM', 'NBBK', 'AVDL', 'VICI', 'FUFU', 'BORR', 'CTKB', 'PDCO', 'AEHL', 'MRC', 'ARIS', 'MREO', 'PLSE', 'ATXS', 'XERS', 'RVMD', 'SNDX', 'MCW', 'FHN', 'NEM', 'NVGS', 'IONS', 'PPC', 'BHVN', 'CDP', 'NKTR', 'WTTR', 'CUBE', 'ERAS', 'BFH', 'MATV', 'JBGS', 'ADPT', 'LXRX', 'EXLS', 'TELL', 'MYO', 'INO', 'ITOS', 'GPRO', 'ERJ', 'OUT', 'SLN', 'AUTL', 'PHIN', 'FDL', 'MAG', 'KYMR', 'TOST', 'JMIA', 'GLPI', 'NBTB', 'LC', 'ESRT', 'CLBT']
