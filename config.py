...
BREAKOUT_SYMBOLS_5MX0_AB = ['EKSO', 'ONL', 'ATOS', 'TPR', 'INFA', 'AES', 'FBLG', 'MTTR', 'MAG', 'SNBR', 'LZ', 'LTRX', 'ANNX', 'ALK', 'SOL', 'U', 'ULCC', 'NIO', 'HYMC', 'DESP', 'GP', 'MPW', 'BGS', 'PRTA', 'BEPC', 'AKYA', 'IMNM', 'HASI', 'VLRS', 'INZY']
