        ...
        if symbol not in existing_position_symbols:
            ...
            if symbol not in existing_order_symbols:
                ...
                # Model_01C: 60m-MACD Continuous (IBKR 2 Feb, CIEN and FIP 1 Mar 2024)                  
                    ...
                    if SBF_60m_01C > SBF_60m_01C_threshold:
                        ...
                        if M_15m_C0 > M_15m_P1 > 0.0000 and H_15m_C0 > 0.0000:
                            ...
                            SBF_15m_01C_01 = H_15m_C0/H_15m_P1
                            SBF_15m_01C_01_threshold = 10
                        ...
                        # Model_01C-02: 15m-MACD Countinuous with H < 0 (PTGX 27-28 Feb 2024)
                            ...
                            SBF_15m_01C_02 = (H_15m_P1-H_15m_C0)/H_15m_P1*100
                            SBF_15m_01C_02_threshold = 50
                        ...
                        # Model_01C-03: 15m-MACD Gap Up (IBKR 2 Feb 2024)
                            ...
                            SBF_15m_01C_03 = H_15m_C0/H_15m_P1
                            SBF_15m_01C_03_threshold = 2
                        ...
                        # Model_01C-04: 15m-MACD Cross Up (DOCN 8 Mar 2024, AMG 14 Mar 2024)
                            ...
                            SCF_15m_01C_04 = (H_15m_P1 - H_15m_C0)/H_15m_P1*100
                            SCF_15m_01C_04_threshold = 100
                ...
                # Model_01D: 60m_MACD cross up at 0-line
                    ...
                    SCF_60m_01D = (H_60m_P1 - H_60m_C0)/H_60m_P1*100          
                    SCF_60m_01D_threshold = 100
