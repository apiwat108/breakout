    ...
    for symbol in symbols:
        ...
        if symbol not in existing_position_symbols:
            ...
            if symbol not in existing_order_symbols:
                ...
                # 60m uptrend with limit of retrace and bullish reversal candlestick pattern (Bullish Engulfing and One White Soldier)
                ...
                if H_60m_C0 > limit_60m_H and C_60m_C0 > C_60m_P1 and C_60m_C0 > O_60m_C0 and 75.0 > RSI_60m_C0 > 50.0: # Could add Bullish Engulfing or One White Soldier
                    ...
                    if H_15m_P1 < 0.0000 and H_15m_C0 > -0.0010 and C_15m_C0 > C_15m_P1 and C_15m_C0 > O_15m_C0 and 75.0 > RSI_15m_C0 > 55.0 and limit_15m_min_M < M_15m_C0 < limit_15m_max_M and V_15m_C0 > V_15m_P1:
                        ...
                        # (TKO 2 Mar 12:20 H_15m_C0 = 0.0269 > H_15m_P1 = -0.0292 --> = 192%)
                        SCF_15m_AB_01 = round((H_15m_P1 - H_15m_C0)/H_15m_P1*100, decimal_point)       
                        SCF_15m_AB_01_threshold = 150.0
                        ...
                        # Case-1-02: 5m-MACD Cross Up sync with 15m TF 
                        # (MCA 20-21 Feb 2024)(MTW 19 Jan 2024 10:00)
                        # (TKO 2 Mar 12:20 H_15m_C0 = 0.0269 > H_15m_P1 = -0.0292 --> = 192%)
                        #           (12:15 Full H_15m_C0 = 0.0706 > H_15m_P1 = -0.0292 --> 342%)
                            ...
                            print(f" - H_15m_P1 = {H_15m_P1} < 0 and H_15m_C0 = {H_15m_C0} > 0")
                            print(f" - H_5m_P1 = {H_5m_P1} < 0 and H_5m_C0 = {H_5m_C0} > 0")
                            print(f" - SCF_15m_AB_01 = {SCF_15m_AB_01} > SCF_15m_AB_01_threshold = {SCF_15m_AB_01_threshold}")
                            quantity = calculate_quantity(market_price)
                            print(f" - Placing buy order for {symbol} at {market_price}.\n")
            ...
            try:
                ...
                if market_value > (1.01 * cost):    # 0 < H_5m_C0 < H_5m_P1 < H_5m_P2 and H_5m_P2 > H_5m_P3 and M_5m_P2 > 0 and S_5m_P3 > 0:
                    ...
                    print(f" - Cost = {cost} and Market Value = {market_value}")
    ...
    for symbol in BB_symbols:
        ...
        if symbol not in existing_position_symbols:
            ...
            if symbol not in existing_order_symbols:
                ...
                if M_60m_C0 > M_60m_P1 > 0.0000 and H_60m_C0 > 0.0000 and H_60m_P1 < 0.0000: # need SBF
                    ...
                    if SCF_60m > SCF_60m_threshold and M_15m_C0 > M_15m_P1 > 0.0000 and H_15m_C0 > H_15m_P1 > 0.0000 and C_15m_C0 > C_15m_P1 and C_15m_C0 > O_15m_C0: 
                        ...
                        if SBF_15m_01A_01 > SBF_15m_01A_01_threshold and M_5m_C0 > M_5m_P1 > 0.0000 and H_5m_C0 > H_5m_P1 > 0.0000:
                            print(f" - It's buy signal for BB Strategy, Model_01A-01-01")
                    ...
                    # Model_01A-02: 15m-MACD cross up --> Condiser to add M_15m_C0 > M_15m_P1 > 0.0000
                        ...
                        # Model_01A-02-01: 5m-MACD cross up
                        # (DOCN 8 Mar 2024: H_5m_C0 = 0.0134 > H_15m_P1 = -0.0127 --> SCF_5m_01A-02-01 = 205%)
                        if SCF_15m_01A_02 > SCF_15m_01A_02_threshold and ((H_5m_C0 > 0.000 and H_5m_P1 < 0.000) or (M_5m_C0 > 0.000 and M_15m_P1 < 0.0000)):
                            print(f" - It's buy signal for BB Strategy, Model_01A-02-01")
                            print(f" - H_60m_C0 = {H_60m_C0}")
                            print(f" - H_60m_P1 = {H_60m_P1}")
                            print(f" - SCF_60m = {SCF_60m} > SCF_60m_threshold = {SCF_60m_threshold}")
                    ...
                    # Model_01A-03: 15m-MACD cross up 0-line
                        ...
                        if SCF_15m_01A_03 > SCF_15m_01A_03_threshold and M_5m_C0 > M_5m_P1 > 0.000 and H_5m_C0 > H_5m_P1 > 0.0000:
                            ...
                            print(f" - 5m conditions do not pass for BB Strategy Model_01A-03-01\n")
                            print(f' - SCF_15m_01A_03 = {SCF_15m_01A_03} < SCF_15m_01A_03_threshold of {SCF_15m_01A_03_threshold}')
                            print(f' - Model_01A-03: 15m-MACD cross up 0-line\n')                          

                    else:
                        print(" - 15m conditions do not pass for BB Strategy Model_01A\n") 
                ...
                # Model_01C: 60m-MACD Keep Rising               
                    ...
                    if SBF_60m_01C > SBF_60m_01C_threshold:
                        print(f" - SBF_60m_01C = {SBF_60m_01C} > SBF_60m_01C_threshold = {SBF_60m_01C_threshold}")                                        

                        # Model_01C-01: 15m-MACD Countinuous with H > 0 (CIEN 1 Mar 2024)
                        ...
                        # Model_01C-02: 15m-MACD Turn Up with H < 0 (PTGX 27-28 Feb 2024)
                            ...
                            if SBF_15m_01C_02 > SBF_15m_01C_02_threshold and C_15m_C0 > C_15m_P1 and C_15m_C0 > O_15m_C0:
                                ...
                                # Model_01C-02-01: 5m-MACD cross up at 0-line 
                                # (PTGX 27-28 Feb 2024)
                                ...
                                if SCF_5m_01C_02_01 > SCF_5m_01C_02_01_threshold and M_5m_C0 > 0.0000 and M_5m_P1 < 0.0000 and H_5m_C0 > 0.0000 and H_5m_P1 < 0.0000:
                                    print(f" - It's buy signal for BB Strategy, Model_01C-02-01")
                                    print(f" - SBF_15m_01C_02 = {SBF_15m_01C_02} > SBF_15m_01C_02_threshold {SBF_15m_01C_02_threshold}") 
                        ...
                        elif H_15m_C0 > 0.0000 and H_15m_P1 < 0.0000 and C_15m_C0 > C_15m_P1 and C_15m_C0 > O_15m_C0:
                ...
                # Model_01E: 60m_MACD cross up 0-line (LAB 1 Mar (10:30-11:30))
                    ...
                    if SCF_60m_01E > SCF_60m_01E_threshold and M_15m_C0 > M_15m_P1 > 0.0000 and H_15m_C0 > H_15m_P1 > 0.0000 and C_15m_C0 > C_15m_P1 and C_15m_C0 > O_15m_C0:
                        ...
                        # Model_01E-01-01: 5m-MACD Keep Rising (LAB 1 Mar 2024: M_5m_C0(11:30) = 0.0302 > M_5m_P1(11:25) = 0.0288)
                        if SBF_15m_01E_01 > SBF_15m_01E_01_threshold and M_5m_C0 > M_5m_P1 > 0.0000 and H_5m_C0 > H_5m_P1 > 0.0000:
                            ...
                            print(" - 5m conditions do not pass\n")  

                    else:
                        print(" - 15m conditions do not pass\n")  

                else:
                    print(" - 60m conditions do not pass for BB Stratergy\n")
            ...
            # Strategy 1 for taking profit 1
            if market_value > (1.020 * cost):    # 0 < H_5m_C0 < H_5m_P1 < H_5m_P2 and H_5m_P2 > H_5m_P3 and M_5m_P2 > 0 and S_5m_P3 > 0:
                print(f" - It's taking-profit signal.")
                print(f" - Placing sell order for {symbol} at {market_price}.\n")
